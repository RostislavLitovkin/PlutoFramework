...
namespace PlutoFrameworkTests
{
    internal class UniqueryPlusEndToEnd
    {
        ...
        {
            Endpoint endpoint = PlutoFramework.Constants.Endpoints.GetEndpointDictionary[EndpointEnum.Local8000];
            Endpoint realEndpoint = PlutoFramework.Constants.Endpoints.GetEndpointDictionary[EndpointEnum.PolkadotAssetHub];
            ...
            var extrinsicId = await client.SubmitExtrinsicAsync(createCollection, alice, new TaskCompletionSource<string?>(), updateExtrinsicsCallback);
