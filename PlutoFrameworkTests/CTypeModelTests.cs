...
namespace PlutoFrameworkTests
{
    public class CTypeModelTests
    {
        ...
        public void ComputeCTypeId()
        {
            ...
            var cTypeId = CTypeModel.ComputeCTypeId(schema);

            Assert.That(cTypeId, Is.EqualTo("kilt:ctype:0x4f1d68ac46daf4613181b33b16faaf10cf94879dc2246d7485dc2ccbb843641d"));
        }
    }
}
