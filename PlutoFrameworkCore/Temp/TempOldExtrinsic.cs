...
public class TempOldExtrinsic
{
    ...
    //
    //   chargeType:
    public TempOldExtrinsic(string str, ChargeType chargeType)
    ...
    //
    //   chargeType:
    internal TempOldExtrinsic(Memory<byte> memory, ChargeType chargeType)
    {
        int p = 0;
    ...
    //
    //   charge:
    public TempOldExtrinsic(bool signed, Account account, CompactInteger nonce, Method method, Era era, ChargeType charge)
    {
        Signed = signed;
