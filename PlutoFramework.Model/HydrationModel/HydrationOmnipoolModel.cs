...
namespace PlutoFramework.Model.HydrationModel
{
    public static class HydrationOmnipoolModel
    {
        ...
        public static async Task<OmnipoolLiquidityInfo> GetOmnipoolLiquidityAtPositionAsync(SubstrateClientExt client, U128 positionId, CancellationToken token)
        {
            ...
            var extAssetPrice = await client.ExternalPriceOracleGetPriceAsync((U32)PlutoFramework.Constants.HydraDX.HUB_ASSET_ID, assetId, token);
            ...
            var currentHubAssetLiquidity = await client.GetFreeBalanceAsync(omnipoolAccount, (U32)PlutoFramework.Constants.HydraDX.HUB_ASSET_ID, token);
