    ...
    public sealed class XcmpQueueStorage
    {
        ...
        public XcmpQueueStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmpQueue", "DeliveryFeeFactor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Mythos.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id), typeof(Mythos.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
        }
        ...
        /// </summary>
        public static string OutboundXcmpMessagesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Mythos.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id, Substrate.NetApi.Model.Types.Primitive.U16> key)
        {
        ...
        /// </summary>
        public static string SignalMessagesParams(Mythos.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id key)
        {
        ...
        ///  The configuration which controls the dynamics of the outbound queue.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.cumulus_pallet_xcmp_queue.QueueConfigData> QueueConfig(string blockhash, CancellationToken token)
        {
            string parameters = XcmpQueueStorage.QueueConfigParams();
            var result = await _client.GetStorageAsync<Mythos.NetApi.Generated.Model.cumulus_pallet_xcmp_queue.QueueConfigData>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string DeliveryFeeFactorParams(Mythos.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id key)
        {
        ...
        ///  The factor to multiply the base delivery fee by.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128> DeliveryFeeFactor(Mythos.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id key, string blockhash, CancellationToken token)
        {
