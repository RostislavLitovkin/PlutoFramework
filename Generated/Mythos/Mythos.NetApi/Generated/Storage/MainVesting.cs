...
namespace Mythos.NetApi.Generated.Storage
{
    ...
    public sealed class VestingStorage
    {
        ...
        /// </summary>
        public static string VestingParams(Mythos.NetApi.Generated.Model.account.AccountId20 key)
        {
        ...
        ///  New networks start with latest version, as determined by the genesis build.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.pallet_vesting.EnumReleases> StorageVersion(string blockhash, CancellationToken token)
        {
            string parameters = VestingStorage.StorageVersionParams();
            var result = await _client.GetStorageAsync<Mythos.NetApi.Generated.Model.pallet_vesting.EnumReleases>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class VestingCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VestOther(Mythos.NetApi.Generated.Model.account.AccountId20 target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VestedTransfer(Mythos.NetApi.Generated.Model.account.AccountId20 target, Mythos.NetApi.Generated.Model.pallet_vesting.vesting_info.VestingInfo schedule)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceVestedTransfer(Mythos.NetApi.Generated.Model.account.AccountId20 source, Mythos.NetApi.Generated.Model.account.AccountId20 target, Mythos.NetApi.Generated.Model.pallet_vesting.vesting_info.VestingInfo schedule)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceRemoveVestingSchedule(Mythos.NetApi.Generated.Model.account.AccountId20 target, Substrate.NetApi.Model.Types.Primitive.U32 schedule_index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
