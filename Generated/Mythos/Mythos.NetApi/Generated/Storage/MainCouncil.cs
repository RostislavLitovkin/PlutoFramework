...
namespace Mythos.NetApi.Generated.Storage
{
    ...
    public sealed class CouncilStorage
    {
        ...
        public CouncilStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Members"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Mythos.NetApi.Generated.Model.account.AccountId20>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Prime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Mythos.NetApi.Generated.Model.account.AccountId20)));
        }
        ...
        /// </summary>
        public static string ProposalOfParams(Mythos.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.mainnet_runtime.EnumRuntimeCall> ProposalOf(Mythos.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VotingParams(Mythos.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.pallet_collective.Votes> Voting(Mythos.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = CouncilStorage.VotingParams(key);
            var result = await _client.GetStorageAsync<Mythos.NetApi.Generated.Model.pallet_collective.Votes>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The current members of the collective. This is stored sorted (just by value).
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Mythos.NetApi.Generated.Model.account.AccountId20>> Members(string blockhash, CancellationToken token)
        {
            string parameters = CouncilStorage.MembersParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Mythos.NetApi.Generated.Model.account.AccountId20>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The prime member that helps determine the default vote behavior in case of abstentions.
        /// </summary>
        public async Task<Mythos.NetApi.Generated.Model.account.AccountId20> Prime(string blockhash, CancellationToken token)
        {
    ...
    public sealed class CouncilCalls
    {
        ...
        /// </summary>
        public static Method SetMembers(Substrate.NetApi.Model.Types.Base.BaseVec<Mythos.NetApi.Generated.Model.account.AccountId20> new_members, Substrate.NetApi.Model.Types.Base.BaseOpt<Mythos.NetApi.Generated.Model.account.AccountId20> prime, Substrate.NetApi.Model.Types.Primitive.U32 old_count)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_members.Encode());
            byteArray.AddRange(prime.Encode());
            byteArray.AddRange(old_count.Encode());
            return new Method(16, "Council", 0, "set_members", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Execute(Mythos.NetApi.Generated.Model.mainnet_runtime.EnumRuntimeCall proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal.Encode());
            byteArray.AddRange(length_bound.Encode());
            return new Method(16, "Council", 1, "execute", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Propose(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> threshold, Mythos.NetApi.Generated.Model.mainnet_runtime.EnumRuntimeCall proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(threshold.Encode());
            byteArray.AddRange(proposal.Encode());
            byteArray.AddRange(length_bound.Encode());
            return new Method(16, "Council", 2, "propose", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Vote(Mythos.NetApi.Generated.Model.primitive_types.H256 proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Substrate.NetApi.Model.Types.Primitive.Bool approve)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal.Encode());
            byteArray.AddRange(index.Encode());
            byteArray.AddRange(approve.Encode());
            return new Method(16, "Council", 3, "vote", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DisapproveProposal(Mythos.NetApi.Generated.Model.primitive_types.H256 proposal_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
            return new Method(16, "Council", 5, "disapprove_proposal", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Close(Mythos.NetApi.Generated.Model.primitive_types.H256 proposal_hash, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Mythos.NetApi.Generated.Model.sp_weights.weight_v2.Weight proposal_weight_bound, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
            byteArray.AddRange(index.Encode());
    ...
    public sealed class CouncilConstants
    {
        ...
        /// </summary>
        public Mythos.NetApi.Generated.Model.sp_weights.weight_v2.Weight MaxProposalWeight()
        {
