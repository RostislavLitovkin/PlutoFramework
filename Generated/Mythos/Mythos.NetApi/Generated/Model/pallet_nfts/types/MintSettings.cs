...
namespace Mythos.NetApi.Generated.Model.pallet_nfts.types
{
    ...
    /// <summary>
    /// >> 257 - Composite[pallet_nfts.types.MintSettings]
    /// </summary>
    ...
    public sealed class MintSettings : BaseType
    {
        ...
        /// >> mint_type
        /// </summary>
        public Mythos.NetApi.Generated.Model.pallet_nfts.types.EnumMintType MintType { get; set; }
        /// <summary>
        /// >> price
        /// </summary>
        ...
        /// </summary>
        public Mythos.NetApi.Generated.Model.pallet_nfts.types.BitFlagsT2 DefaultItemSettings { get; set; }
        /// <summary>
        /// >> serial_mint
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.Bool SerialMint { get; set; }
        ...
        public override byte[] Encode()
        {
            ...
            result.AddRange(SerialMint.Encode());
        ...
        {
            var start = p;
            MintType = new Mythos.NetApi.Generated.Model.pallet_nfts.types.EnumMintType();
            ...
            DefaultItemSettings = new Mythos.NetApi.Generated.Model.pallet_nfts.types.BitFlagsT2();
            DefaultItemSettings.Decode(byteArray, ref p);
            SerialMint = new Substrate.NetApi.Model.Types.Primitive.Bool();
            SerialMint.Decode(byteArray, ref p);
