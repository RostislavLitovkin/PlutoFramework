...
namespace Mythos.NetApi.Generated.Model.sp_runtime
{
    ...
    /// <summary>
    /// >> 27 - Variant[sp_runtime.DispatchError]
    /// </summary>
    public sealed class EnumDispatchError : BaseEnumRust<DispatchError>
    {
        ...
        public EnumDispatchError()
        {
				...
				AddTypeDecoder<Mythos.NetApi.Generated.Model.sp_runtime.ModuleError>(DispatchError.Module);
				...
				AddTypeDecoder<Mythos.NetApi.Generated.Model.sp_runtime.EnumTokenError>(DispatchError.Token);
				AddTypeDecoder<Mythos.NetApi.Generated.Model.sp_arithmetic.EnumArithmeticError>(DispatchError.Arithmetic);
				AddTypeDecoder<Mythos.NetApi.Generated.Model.sp_runtime.EnumTransactionalError>(DispatchError.Transactional);
				...
				AddTypeDecoder<Mythos.NetApi.Generated.Model.sp_runtime.proving_trie.EnumTrieError>(DispatchError.Trie);
        }
    }
}
