...
namespace Mythos.NetApi.Generated.Model.staging_xcm.v5.asset
{
    ...
    /// <summary>
    /// >> 105 - Variant[staging_xcm.v5.asset.Fungibility]
    /// </summary>
    public sealed class EnumFungibility : BaseEnumRust<Fungibility>
    {
        ...
        public EnumFungibility()
        {
				...
				AddTypeDecoder<Mythos.NetApi.Generated.Model.staging_xcm.v5.asset.EnumAssetInstance>(Fungibility.NonFungible);
        }
    }
}
