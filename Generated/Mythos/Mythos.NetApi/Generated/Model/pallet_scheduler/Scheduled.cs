...
namespace Mythos.NetApi.Generated.Model.pallet_scheduler
{
    
    
    /// <summary>
    /// >> 378 - Composite[pallet_scheduler.Scheduled]
    /// </summary>
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Mythos.NetApi.Generated.Types.Base.Arr32U8> MaybeId { get; set; }
        /// <summary>
        /// >> priority
        /// </summary>
        ...
        /// >> call
        /// </summary>
        public Mythos.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded Call { get; set; }
        /// <summary>
        /// >> maybe_periodic
        /// </summary>
        ...
        /// >> origin
        /// </summary>
        public Mythos.NetApi.Generated.Model.mainnet_runtime.EnumOriginCaller Origin { get; set; }
        ...
        {
            var start = p;
            MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Mythos.NetApi.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Substrate.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new Mythos.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded();
            ...
            Origin = new Mythos.NetApi.Generated.Model.mainnet_runtime.EnumOriginCaller();
