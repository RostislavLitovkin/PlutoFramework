...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class AttestationStorage
    {
        ...
        public AttestationStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Attestation", "Attestations"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256), typeof(KiltPeregrine.NetApi.Generated.Model.attestation.attestations.AttestationDetails)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Attestation", "ExternalAttestations"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumAuthorizationId, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256>), typeof(Substrate.NetApi.Model.Types.Primitive.Bool)));
        }
        ...
        /// </summary>
        public static string AttestationsParams(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  It maps from a claim hash to the full attestation.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.attestation.attestations.AttestationDetails> Attestations(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = AttestationStorage.AttestationsParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.attestation.attestations.AttestationDetails>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ExternalAttestationsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumAuthorizationId, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256> key)
        {
        ...
        ///  It maps from a delegation ID to a vector of claim hashes.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> ExternalAttestations(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumAuthorizationId, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256> key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class AttestationCalls
    {
        ...
        /// </summary>
        public static Method Add(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 claim_hash, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 ctype_hash, Substrate.NetApi.Model.Types.Base.BaseOpt<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumPalletAuthorize> authorization)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Revoke(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 claim_hash, Substrate.NetApi.Model.Types.Base.BaseOpt<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumPalletAuthorize> authorization)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(claim_hash.Encode());
            byteArray.AddRange(authorization.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Remove(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 claim_hash, Substrate.NetApi.Model.Types.Base.BaseOpt<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumPalletAuthorize> authorization)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(claim_hash.Encode());
            byteArray.AddRange(authorization.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReclaimDeposit(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 claim_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(claim_hash.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ChangeDepositOwner(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 claim_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(claim_hash.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateDeposit(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 claim_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(claim_hash.Encode());
