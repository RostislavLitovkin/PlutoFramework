...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class CtypeStorage
    {
        ...
        public CtypeStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ctype", "Ctypes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256), typeof(KiltPeregrine.NetApi.Generated.Model.ctype.ctype_entry.CtypeEntry)));
        }
        ...
        ///  was created.
        /// </summary>
        public static string CtypesParams(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  was created.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.ctype.ctype_entry.CtypeEntry> Ctypes(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = CtypeStorage.CtypesParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.ctype.ctype_entry.CtypeEntry>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class CtypeCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetBlockNumber(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 ctype_hash, Substrate.NetApi.Model.Types.Primitive.U64 block_number)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
