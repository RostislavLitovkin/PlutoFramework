...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class DidStorage
    {
        ...
        public DidStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Did", "Did"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(KiltPeregrine.NetApi.Generated.Model.did.did_details.DidDetails)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Did", "ServiceEndpoints"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18>), typeof(KiltPeregrine.NetApi.Generated.Model.did.service_endpoints.DidEndpoint)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Did", "DidEndpointsCount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Did", "DidBlacklist"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
        }
        ...
        /// </summary>
        public static string DidParams(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  It maps from a DID identifier to the DID details.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.did.did_details.DidDetails> Did(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = DidStorage.DidParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.did.did_details.DidDetails>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ServiceEndpointsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18> key)
        {
        ...
        ///  It maps from (DID identifier, service ID) to the service details.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.did.service_endpoints.DidEndpoint> ServiceEndpoints(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18> key, string blockhash, CancellationToken token)
        {
            string parameters = DidStorage.ServiceEndpointsParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.did.service_endpoints.DidEndpoint>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string DidEndpointsCountParams(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  It maps from (DID identifier) to a 32-bit counter.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> DidEndpointsCount(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  DID identifiers.
        /// </summary>
        public static string DidBlacklistParams(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  DID identifiers.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> DidBlacklist(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class DidCalls
    {
        ...
        /// </summary>
        public static Method Create(KiltPeregrine.NetApi.Generated.Model.did.did_details.DidCreationDetails details, KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidSignature signature)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAuthenticationKey(KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetDelegationKey(KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_key.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAttestationKey(KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_key.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddKeyAgreementKey(KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidEncryptionKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_key.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveKeyAgreementKey(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddServiceEndpoint(KiltPeregrine.NetApi.Generated.Model.did.service_endpoints.DidEndpoint service_endpoint)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveServiceEndpoint(KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18 service_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReclaimDeposit(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 did_subject, Substrate.NetApi.Model.Types.Primitive.U32 endpoints_to_remove)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SubmitDidCall(KiltPeregrine.NetApi.Generated.Model.did.did_details.DidAuthorizedCallOperation did_call, KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidSignature signature)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateDeposit(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 did)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DispatchAs(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 did_identifier, KiltPeregrine.NetApi.Generated.Model.peregrine_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CreateFromAccount(KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey authentication_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
