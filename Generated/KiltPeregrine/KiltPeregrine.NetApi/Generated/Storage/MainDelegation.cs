...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class DelegationStorage
    {
        ...
        public DelegationStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Delegation", "DelegationNodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256), typeof(KiltPeregrine.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationNode)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Delegation", "DelegationHierarchies"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256), typeof(KiltPeregrine.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationHierarchyDetails)));
        }
        ...
        /// </summary>
        public static string DelegationNodesParams(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  It maps from a node ID to the node details.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationNode> DelegationNodes(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = DelegationStorage.DelegationNodesParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationNode>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string DelegationHierarchiesParams(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  It maps for a (root) node ID to the hierarchy details.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationHierarchyDetails> DelegationHierarchies(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = DelegationStorage.DelegationHierarchiesParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationHierarchyDetails>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class DelegationCalls
    {
        ...
        /// </summary>
        public static Method CreateHierarchy(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 root_node_id, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 ctype_hash)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddDelegation(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 delegation_id, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 parent_id, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 @delegate, KiltPeregrine.NetApi.Generated.Model.delegation.delegation_hierarchy.Permissions permissions, KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidSignature delegate_signature)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RevokeDelegation(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 delegation_id, Substrate.NetApi.Model.Types.Primitive.U32 max_parent_checks, Substrate.NetApi.Model.Types.Primitive.U32 max_revocations)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveDelegation(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 delegation_id, Substrate.NetApi.Model.Types.Primitive.U32 max_removals)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReclaimDeposit(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 delegation_id, Substrate.NetApi.Model.Types.Primitive.U32 max_removals)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
            byteArray.AddRange(max_removals.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ChangeDepositOwner(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 delegation_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateDeposit(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 delegation_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
