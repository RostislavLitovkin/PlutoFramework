...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class TokenGatewayStorage
    {
        ...
        public TokenGatewayStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TokenGateway", "SupportedAssets"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location), typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TokenGateway", "NativeAssets"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location), typeof(Substrate.NetApi.Model.Types.Primitive.Bool)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TokenGateway", "LocalAssets"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256), typeof(KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TokenGateway", "Precisions"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location, KiltPeregrine.NetApi.Generated.Model.ismp.host.EnumStateMachine>), typeof(Substrate.NetApi.Model.Types.Primitive.U8)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TokenGateway", "TokenGatewayAddresses"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.ismp.host.EnumStateMachine), typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>)));
        }
        ...
        /// </summary>
        public static string SupportedAssetsParams(KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location key)
        {
        ...
        ///  A map of the local asset id to the token gateway asset id
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.primitive_types.H256> SupportedAssets(KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string NativeAssetsParams(KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location key)
        {
        ...
        ///  Assets that originate from this chain
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> NativeAssets(KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string LocalAssetsParams(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  A map of the token gateway asset id to the local asset id
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location> LocalAssets(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string PrecisionsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location, KiltPeregrine.NetApi.Generated.Model.ismp.host.EnumStateMachine> key)
        {
        ...
        ///  The decimals used by the EVM counterpart of this asset
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U8> Precisions(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location, KiltPeregrine.NetApi.Generated.Model.ismp.host.EnumStateMachine> key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string TokenGatewayAddressesParams(KiltPeregrine.NetApi.Generated.Model.ismp.host.EnumStateMachine key)
        {
        ...
        ///  The token gateway adresses on different chains
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> TokenGatewayAddresses(KiltPeregrine.NetApi.Generated.Model.ismp.host.EnumStateMachine key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class TokenGatewayCalls
    {
        ...
        /// </summary>
        public static Method Teleport(KiltPeregrine.NetApi.Generated.Model.pallet_token_gateway.types.TeleportParams @params)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetTokenGatewayAddresses(KiltPeregrine.NetApi.Generated.Types.Base.BTreeMapT4 addresses)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CreateErc6160Asset(KiltPeregrine.NetApi.Generated.Model.pallet_token_gateway.types.AssetRegistration asset)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateErc6160Asset(KiltPeregrine.NetApi.Generated.Model.token_gateway_primitives.GatewayAssetUpdate asset)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateAssetPrecision(KiltPeregrine.NetApi.Generated.Model.pallet_token_gateway.types.PrecisionUpdate update)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
