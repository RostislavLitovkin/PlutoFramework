...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class Web3NamesStorage
    {
        ...
        public Web3NamesStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Web3Names", "Owner"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name), typeof(KiltPeregrine.NetApi.Generated.Model.pallet_web3_names.web3_name.Web3NameOwnership)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Web3Names", "Names"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Web3Names", "Banned"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
        }
        ...
        /// </summary>
        public static string OwnerParams(KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name key)
        {
        ...
        ///  Map of name -> ownership details.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.pallet_web3_names.web3_name.Web3NameOwnership> Owner(KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name key, string blockhash, CancellationToken token)
        {
            string parameters = Web3NamesStorage.OwnerParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.pallet_web3_names.web3_name.Web3NameOwnership>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Map of owner -> name.
        /// </summary>
        public static string NamesParams(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Map of owner -> name.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name> Names(KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = Web3NamesStorage.NamesParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string BannedParams(KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name key)
        {
        ...
        ///  If a name key is present, the name is currently banned.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> Banned(KiltPeregrine.NetApi.Generated.Model.runtime_common.web3_names.Web3Name key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class Web3NamesCalls
    {
        ...
        /// </summary>
        public static Method Claim(KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 name)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReclaimDeposit(KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 name)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(name.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Ban(KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 name)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(name.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Unban(KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 name)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(name.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateDeposit(KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 name_input)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
