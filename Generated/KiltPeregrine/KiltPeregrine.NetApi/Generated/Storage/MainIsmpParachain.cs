...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class IsmpParachainStorage
    {
        ...
        public IsmpParachainStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("IsmpParachain", "RelayChainStateCommitments"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256)));
        ...
        ///  parachain-system.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.primitive_types.H256> RelayChainStateCommitments(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class IsmpParachainCalls
    {
        ...
        /// </summary>
        public static Method UpdateParachainConsensus(KiltPeregrine.NetApi.Generated.Model.ismp.messaging.ConsensusMessage data)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddParachain(Substrate.NetApi.Model.Types.Base.BaseVec<KiltPeregrine.NetApi.Generated.Model.ismp_parachain.ParachainData> para_ids)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
