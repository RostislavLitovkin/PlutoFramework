...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class MigrationStorage
    {
        ...
        public MigrationStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Migration", "MigratedKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
        }
        
        /// <summary>
        /// >> MigratedKeysParams
        /// </summary>
        public static string MigratedKeysParams(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        /// >> MigratedKeys
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> MigratedKeys(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class MigrationCalls
    {
        ...
        /// </summary>
        public static Method UpdateBalance(KiltPeregrine.NetApi.Generated.Model.pallet_migration.pallet.EntriesToMigrate requested_migrations)
        {
