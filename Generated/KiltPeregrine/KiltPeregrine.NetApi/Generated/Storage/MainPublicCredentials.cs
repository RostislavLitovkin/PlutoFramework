...
namespace KiltPeregrine.NetApi.Generated.Storage
{
    ...
    public sealed class PublicCredentialsStorage
    {
        ...
        public PublicCredentialsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PublicCredentials", "Credentials"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.runtime_common.assets.AssetDid, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256>), typeof(KiltPeregrine.NetApi.Generated.Model.public_credentials.credentials.CredentialEntry)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PublicCredentials", "CredentialSubjects"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256), typeof(KiltPeregrine.NetApi.Generated.Model.runtime_common.assets.AssetDid)));
        }
        ...
        /// </summary>
        public static string CredentialsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.runtime_common.assets.AssetDid, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256> key)
        {
        ...
        ///  details of the credential.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.public_credentials.credentials.CredentialEntry> Credentials(Substrate.NetApi.Model.Types.Base.BaseTuple<KiltPeregrine.NetApi.Generated.Model.runtime_common.assets.AssetDid, KiltPeregrine.NetApi.Generated.Model.primitive_types.H256> key, string blockhash, CancellationToken token)
        {
            string parameters = PublicCredentialsStorage.CredentialsParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.public_credentials.credentials.CredentialEntry>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string CredentialSubjectsParams(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  It it used to perform efficient lookup of credentials given their ID.
        /// </summary>
        public async Task<KiltPeregrine.NetApi.Generated.Model.runtime_common.assets.AssetDid> CredentialSubjects(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = PublicCredentialsStorage.CredentialSubjectsParams(key);
            var result = await _client.GetStorageAsync<KiltPeregrine.NetApi.Generated.Model.runtime_common.assets.AssetDid>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class PublicCredentialsCalls
    {
        ...
        /// </summary>
        public static Method Add(KiltPeregrine.NetApi.Generated.Model.public_credentials.credentials.Credential credential)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Revoke(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 credential_id, Substrate.NetApi.Model.Types.Base.BaseOpt<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumPalletAuthorize> authorization)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Unrevoke(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 credential_id, Substrate.NetApi.Model.Types.Base.BaseOpt<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumPalletAuthorize> authorization)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(credential_id.Encode());
            byteArray.AddRange(authorization.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Remove(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 credential_id, Substrate.NetApi.Model.Types.Base.BaseOpt<KiltPeregrine.NetApi.Generated.Model.runtime_common.authorization.EnumPalletAuthorize> authorization)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(credential_id.Encode());
            byteArray.AddRange(authorization.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReclaimDeposit(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 credential_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(credential_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ChangeDepositOwner(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 credential_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(credential_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateDeposit(KiltPeregrine.NetApi.Generated.Model.primitive_types.H256 credential_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(credential_id.Encode());
