...
namespace KiltPeregrine.NetApi.Generated.Model.did.did_details
{
    ...
    /// <summary>
    /// >> 642 - Composite[did.did_details.DidPublicKeyDetails]
    /// </summary>
    ...
    public sealed class DidPublicKeyDetails : BaseType
    {
        ...
        /// >> key
        /// </summary>
        public KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidPublicKey Key { get; set; }
        /// <summary>
        /// >> block_number
        /// </summary>
        ...
        {
            var start = p;
            Key = new KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidPublicKey();
