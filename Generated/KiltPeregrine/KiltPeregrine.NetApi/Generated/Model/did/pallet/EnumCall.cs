...
namespace KiltPeregrine.NetApi.Generated.Model.did.pallet
{
    ...
    public sealed class EnumCall : BaseEnumRust<Call>
    {
        ...
        public EnumCall()
        {
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.did.did_details.DidCreationDetails, KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidSignature>>(Call.create);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey>(Call.set_authentication_key);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey>(Call.set_delegation_key);
				AddTypeDecoder<BaseVoid>(Call.remove_delegation_key);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey>(Call.set_attestation_key);
				AddTypeDecoder<BaseVoid>(Call.remove_attestation_key);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidEncryptionKey>(Call.add_key_agreement_key);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.primitive_types.H256>(Call.remove_key_agreement_key);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.did.service_endpoints.DidEndpoint>(Call.add_service_endpoint);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18>(Call.remove_service_endpoint);
				AddTypeDecoder<Substrate.NetApi.Model.Types.Primitive.U32>(Call.delete);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.reclaim_deposit);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.did.did_details.DidAuthorizedCallOperation, KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidSignature>>(Call.submit_did_call);
				AddTypeDecoder<BaseVoid>(Call.change_deposit_owner);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32>(Call.update_deposit);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.peregrine_runtime.EnumRuntimeCall>>(Call.dispatch_as);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey>(Call.create_from_account);
        }
    }
}
