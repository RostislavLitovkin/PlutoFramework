...
namespace KiltPeregrine.NetApi.Generated.Model.parachain_staking.pallet
{
    ...
    public sealed class EnumEvent : BaseEnumRust<Event>
    {
        ...
        public EnumEvent()
        {
				...
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32>(Event.EnteredTopCandidates);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32>(Event.LeftTopCandidates);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.JoinedCollatorCandidates);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.CollatorStakedMore);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.CollatorStakedLess);
				AddTypeDecoder<BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(Event.CollatorScheduledExit);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32>(Event.CollatorCanceledExit);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.CandidateLeft);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.CollatorRemoved);
				AddTypeDecoder<Substrate.NetApi.Model.Types.Primitive.U128>(Event.MaxCandidateStakeChanged);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.DelegatorStakedMore);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.DelegatorStakedLess);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.DelegatorLeft);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.Delegation);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.DelegationReplaced);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.DelegatorLeftCollator);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(Event.Rewarded);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_arithmetic.per_things.Perquintill, KiltPeregrine.NetApi.Generated.Model.sp_arithmetic.per_things.Perquintill, KiltPeregrine.NetApi.Generated.Model.sp_arithmetic.per_things.Perquintill, KiltPeregrine.NetApi.Generated.Model.sp_arithmetic.per_things.Perquintill>>(Event.RoundInflationSet);
