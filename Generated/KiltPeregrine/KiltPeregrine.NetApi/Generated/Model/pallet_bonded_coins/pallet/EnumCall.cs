...
namespace KiltPeregrine.NetApi.Generated.Model.pallet_bonded_coins.pallet
{
    ...
    public sealed class EnumCall : BaseEnumRust<Call>
    {
        ...
        public EnumCall()
        {
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.pallet_bonded_coins.curves.EnumCurveInput, KiltPeregrine.NetApi.Generated.Model.staging_xcm.v4.location.Location, KiltPeregrine.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26, KiltPeregrine.NetApi.Generated.Model.pallet_bonded_coins.types.BondedCurrenciesSettings>>(Call.create_pool);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.pallet_bonded_coins.types.PoolManagingTeam, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.reset_team);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Base.BaseOpt<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32>>>(Call.reset_manager);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.pallet_bonded_coins.types.Locks>>(Call.set_lock);
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32>(Call.unlock);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32, KiltPeregrine.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.mint_into);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32, KiltPeregrine.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.burn_into);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.start_refund);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.force_start_refund);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, KiltPeregrine.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.refund_account);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.start_destroy);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.force_start_destroy);
				AddTypeDecoder<BaseTuple<KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.finish_destroy);
        }
    }
}
