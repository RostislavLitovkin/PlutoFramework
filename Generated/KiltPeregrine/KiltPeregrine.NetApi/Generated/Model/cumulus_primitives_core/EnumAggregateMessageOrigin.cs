...
namespace KiltPeregrine.NetApi.Generated.Model.cumulus_primitives_core
{
    ...
    public sealed class EnumAggregateMessageOrigin : BaseEnumRust<AggregateMessageOrigin>
    {
        ...
        public EnumAggregateMessageOrigin()
        {
				...
				AddTypeDecoder<KiltPeregrine.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id>(AggregateMessageOrigin.Sibling);
        }
    }
}
