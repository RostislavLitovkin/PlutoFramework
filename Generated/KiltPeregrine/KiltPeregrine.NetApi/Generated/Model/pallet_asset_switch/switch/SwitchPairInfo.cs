...
namespace KiltPeregrine.NetApi.Generated.Model.pallet_asset_switch.@switch
{
    ...
    public sealed class SwitchPairInfo : BaseType
    {
        ...
        /// >> pool_account
        /// </summary>
        public KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32 PoolAccount { get; set; }
        /// <summary>
        ...
        /// >> remote_asset_id
        /// </summary>
        public KiltPeregrine.NetApi.Generated.Model.xcm.EnumVersionedAssetId RemoteAssetId { get; set; }
        /// <summary>
        ...
        /// </summary>
        public KiltPeregrine.NetApi.Generated.Model.xcm.EnumVersionedLocation RemoteReserveLocation { get; set; }
        /// <summary>
        /// >> remote_xcm_fee
        /// </summary>
        public KiltPeregrine.NetApi.Generated.Model.xcm.EnumVersionedAsset RemoteXcmFee { get; set; }
        /// <summary>
        /// >> status
        /// </summary>
        public KiltPeregrine.NetApi.Generated.Model.pallet_asset_switch.switch.EnumSwitchPairStatus Status { get; set; }
        /// <summary>
        ...
        {
            var start = p;
            PoolAccount = new KiltPeregrine.NetApi.Generated.Model.sp_core.crypto.AccountId32();
            ...
            RemoteAssetId = new KiltPeregrine.NetApi.Generated.Model.xcm.EnumVersionedAssetId();
            ...
            RemoteReserveLocation = new KiltPeregrine.NetApi.Generated.Model.xcm.EnumVersionedLocation();
            RemoteReserveLocation.Decode(byteArray, ref p);
            RemoteXcmFee = new KiltPeregrine.NetApi.Generated.Model.xcm.EnumVersionedAsset();
            RemoteXcmFee.Decode(byteArray, ref p);
            Status = new KiltPeregrine.NetApi.Generated.Model.pallet_asset_switch.switch.EnumSwitchPairStatus();
