...
namespace PolkadotAssetHub.NetApi.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 271 - Composite[cumulus_pallet_xcmp_queue.OutboundChannelDetails]
    /// </summary>
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        public PolkadotAssetHub.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id Recipient { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public PolkadotAssetHub.NetApi.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State { get; set; }
        /// <summary>
        /// >> signals_exist
        /// </summary>
        ...
        {
            var start = p;
            Recipient = new PolkadotAssetHub.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id();
            Recipient.Decode(byteArray, ref p);
            State = new PolkadotAssetHub.NetApi.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState();
