...
namespace PolkadotAssetHub.NetApi.Generated.Model.pallet_rc_migrator.staking.message
{
    ...
    public sealed class PortableValidatorPrefs : BaseType
    {
        ...
        /// >> commission
        /// </summary>
        public PolkadotAssetHub.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill Commission { get; set; }
        /// <summary>
        /// >> blocked
        /// </summary>
        ...
        {
            var start = p;
            Commission = new PolkadotAssetHub.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill();
