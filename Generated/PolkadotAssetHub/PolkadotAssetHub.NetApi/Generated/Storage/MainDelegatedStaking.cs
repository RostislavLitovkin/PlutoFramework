...
namespace PolkadotAssetHub.NetApi.Generated.Storage
{
    ...
    public sealed class DelegatedStakingStorage
    {
        ...
        public DelegatedStakingStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DelegatedStaking", "Delegators"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(PolkadotAssetHub.NetApi.Generated.Model.pallet_delegated_staking.types.Delegation)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DelegatedStaking", "Agents"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(PolkadotAssetHub.NetApi.Generated.Model.pallet_delegated_staking.types.AgentLedger)));
        ...
        /// </summary>
        public static string DelegatorsParams(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  as keys since we want to restrict delegators to delegate only to one account at a time.
        /// </summary>
        public async Task<PolkadotAssetHub.NetApi.Generated.Model.pallet_delegated_staking.types.Delegation> Delegators(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = DelegatedStakingStorage.DelegatorsParams(key);
            var result = await _client.GetStorageAsync<PolkadotAssetHub.NetApi.Generated.Model.pallet_delegated_staking.types.Delegation>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string AgentsParams(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Map of `Agent` to their `Ledger`.
        /// </summary>
        public async Task<PolkadotAssetHub.NetApi.Generated.Model.pallet_delegated_staking.types.AgentLedger> Agents(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = DelegatedStakingStorage.AgentsParams(key);
            var result = await _client.GetStorageAsync<PolkadotAssetHub.NetApi.Generated.Model.pallet_delegated_staking.types.AgentLedger>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class DelegatedStakingConstants
    {
        ...
        /// </summary>
        public PolkadotAssetHub.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill SlashRewardFraction()
        {
