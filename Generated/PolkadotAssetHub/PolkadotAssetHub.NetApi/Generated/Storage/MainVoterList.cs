...
namespace PolkadotAssetHub.NetApi.Generated.Storage
{
    ...
    public sealed class VoterListStorage
    {
        ...
        public VoterListStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListNodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(PolkadotAssetHub.NetApi.Generated.Model.pallet_bags_list.list.Node)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListBags"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U64), typeof(PolkadotAssetHub.NetApi.Generated.Model.pallet_bags_list.list.Bag)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "NextNodeAutoRebagged"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
        ...
        /// </summary>
        public static string ListNodesParams(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public async Task<PolkadotAssetHub.NetApi.Generated.Model.pallet_bags_list.list.Node> ListNodes(PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = VoterListStorage.ListNodesParams(key);
            var result = await _client.GetStorageAsync<PolkadotAssetHub.NetApi.Generated.Model.pallet_bags_list.list.Node>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public async Task<PolkadotAssetHub.NetApi.Generated.Model.pallet_bags_list.list.Bag> ListBags(Substrate.NetApi.Model.Types.Primitive.U64 key, string blockhash, CancellationToken token)
        {
            string parameters = VoterListStorage.ListBagsParams(key);
            var result = await _client.GetStorageAsync<PolkadotAssetHub.NetApi.Generated.Model.pallet_bags_list.list.Bag>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  When `None`, the next scan will start from the list head again.
        /// </summary>
        public async Task<PolkadotAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32> NextNodeAutoRebagged(string blockhash, CancellationToken token)
        {
    ...
    public sealed class VoterListCalls
    {
        ...
        /// </summary>
        public static Method Rebag(PolkadotAssetHub.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress dislocated)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dislocated.Encode());
            return new Method(82, "VoterList", 0, "rebag", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method PutInFrontOf(PolkadotAssetHub.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(lighter.Encode());
            return new Method(82, "VoterList", 1, "put_in_front_of", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method PutInFrontOfOther(PolkadotAssetHub.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress heavier, PolkadotAssetHub.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(heavier.Encode());
            byteArray.AddRange(lighter.Encode());
            return new Method(82, "VoterList", 2, "put_in_front_of_other", byteArray.ToArray());
        }
    }
