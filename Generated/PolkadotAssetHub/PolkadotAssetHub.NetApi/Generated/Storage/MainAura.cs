...
namespace PolkadotAssetHub.NetApi.Generated.Storage
{
    ...
    public sealed class AuraStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Aura", "Authorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(PolkadotAssetHub.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Aura", "CurrentSlot"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(PolkadotAssetHub.NetApi.Generated.Model.sp_consensus_slots.Slot)));
        }
        ...
        ///  This will be set in `on_initialize`.
        /// </summary>
        public async Task<PolkadotAssetHub.NetApi.Generated.Model.sp_consensus_slots.Slot> CurrentSlot(string blockhash, CancellationToken token)
        {
            string parameters = AuraStorage.CurrentSlotParams();
            var result = await _client.GetStorageAsync<PolkadotAssetHub.NetApi.Generated.Model.sp_consensus_slots.Slot>(parameters, blockhash, token);
            return result;
        }
    }
