...
namespace KusamaAssetHub.NetApi.Generated.Model.sp_runtime.multiaddress
{
    ...
    public sealed class EnumMultiAddress : BaseEnumRust<MultiAddress>
    {
        ...
        {
				AddTypeDecoder<KusamaAssetHub.NetApi.Generated.Model.sp_core.crypto.AccountId32>(MultiAddress.Id);
				...
				AddTypeDecoder<KusamaAssetHub.NetApi.Generated.Types.Base.Arr32U8>(MultiAddress.Address32);
				AddTypeDecoder<KusamaAssetHub.NetApi.Generated.Types.Base.Arr20U8>(MultiAddress.Address20);
        }
    }
}
