...
namespace XCavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class ConvictionVotingStorage
    {
        ...
        public ConvictionVotingStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ConvictionVoting", "VotingFor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<XCavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U16>), typeof(XCavatePaseo.NetApi.Generated.Model.pallet_conviction_voting.vote.EnumVoting)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ConvictionVoting", "ClassLocksFor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(XCavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(XCavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24)));
        }
        ...
        /// </summary>
        public static string VotingForParams(Substrate.NetApi.Model.Types.Base.BaseTuple<XCavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U16> key)
        {
        ...
        ///  number of votes that we have recorded.
        /// </summary>
        public async Task<XCavatePaseo.NetApi.Generated.Model.pallet_conviction_voting.vote.EnumVoting> VotingFor(Substrate.NetApi.Model.Types.Base.BaseTuple<XCavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U16> key, string blockhash, CancellationToken token)
        {
            string parameters = ConvictionVotingStorage.VotingForParams(key);
            var result = await _client.GetStorageAsync<XCavatePaseo.NetApi.Generated.Model.pallet_conviction_voting.vote.EnumVoting>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  this list.
        /// </summary>
        public static string ClassLocksForParams(XCavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  this list.
        /// </summary>
        public async Task<XCavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24> ClassLocksFor(XCavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class ConvictionVotingCalls
    {
        ...
        /// </summary>
        public static Method Vote(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> poll_index, XCavatePaseo.NetApi.Generated.Model.pallet_conviction_voting.vote.EnumAccountVote vote)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Delegate(Substrate.NetApi.Model.Types.Primitive.U16 @class, XCavatePaseo.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress to, XCavatePaseo.NetApi.Generated.Model.pallet_conviction_voting.conviction.EnumConviction conviction, Substrate.NetApi.Model.Types.Primitive.U128 balance)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Unlock(Substrate.NetApi.Model.Types.Primitive.U16 @class, XCavatePaseo.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@class.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveOtherVote(XCavatePaseo.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target, Substrate.NetApi.Model.Types.Primitive.U16 @class, Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
            byteArray.AddRange(@class.Encode());
