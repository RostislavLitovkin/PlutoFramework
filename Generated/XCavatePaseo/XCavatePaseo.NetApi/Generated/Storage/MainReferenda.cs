...
namespace XCavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class ReferendaStorage
    {
        ...
        public ReferendaStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Referenda", "ReferendumInfoFor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(XCavatePaseo.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Referenda", "TrackQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(XCavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT25)));
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public async Task<XCavatePaseo.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoFor(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = ReferendaStorage.ReferendumInfoForParams(key);
            var result = await _client.GetStorageAsync<XCavatePaseo.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<XCavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT25> TrackQueue(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
        ...
        ///  large preimages.
        /// </summary>
        public async Task<XCavatePaseo.NetApi.Generated.Model.primitive_types.H256> MetadataOf(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class ReferendaCalls
    {
        ...
        /// </summary>
        public static Method Submit(XCavatePaseo.NetApi.Generated.Model.generic_runtime_template.EnumOriginCaller proposal_origin, XCavatePaseo.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, XCavatePaseo.NetApi.Generated.Model.frame_support.traits.schedule.EnumDispatchTime enactment_moment)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetMetadata(Substrate.NetApi.Model.Types.Primitive.U32 index, Substrate.NetApi.Model.Types.Base.BaseOpt<XCavatePaseo.NetApi.Generated.Model.primitive_types.H256> maybe_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
    ...
    public sealed class ReferendaConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Primitive.U128 SubmissionDeposit()
        {
            ...
            result.Create("0x0030EF7DBA0200000000000000000000");
            return result;
        }
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, XCavatePaseo.NetApi.Generated.Model.pallet_referenda.types.TrackInfo>> Tracks()
        {
            var result = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, XCavatePaseo.NetApi.Generated.Model.pallet_referenda.types.TrackInfo>>();
            result.Create("0x28000010726F6F74010000000000E8890423C78A000000000000000028000000640000003C00000" +
                    "0190000000290D73E0D000000005743DE13000000005443DE13000000000000CA9A3B00000000006" +
                    "5CD1D01004877686974656C69737465645F63616C6C657264000000000064A7B3B6E00D000000000" +
                    "00000001E00000064000000140000000F00000002EC972510000000007B573C170000000042392F1" +
                    "200000000020E00840000000000D6E61F010000000039627902000000000B0024747265617375726" +
                    "5720A00000000008A5D784563010000000000000000280000006400000028000000190000000290D" +
                    "73E0D000000005743DE13000000005443DE13000000000000CA9A3B000000000065CD1D140050726" +
                    "5666572656E64756D5F63616E63656C6C6572E8030000000064A7B3B6E00D0000000000000000280" +
                    "0000046000000280000000F00000000C94330240065CD1D00CA9A3B025D6F780000000000E82EED0" +
                    "0000000008C6889FFFFFFFFFF1500447265666572656E64756D5F6B696C6C6572E80300000000F44" +
                    "48291634500000000000000002800000064000000280000000F00000000C94330240065CD1D00CA9" +
                    "A3B025D6F780000000000E82EED00000000008C6889FFFFFFFFFF1E0030736D616C6C5F746970706" +
                    "572C80000000030EF7DBA02000000000000000000000500000046000000140000000500000000499" +
                    "149150065CD1D00CA9A3B02F9BA1800000000002A4D3100000000006B59E7FFFFFFFFFF1F0028626" +
                    "9675F7469707065726400000000E057EB481B0000000000000000000014000000460000003C00000" +
                    "00F00000000499149150065CD1D00CA9A3B02694F3F000000000035967D0000000000E534C1FFFFF" +
                    "FFFFF200034736D616C6C5F7370656E6465723200000000C06E31D91001000000000000000000320" +
                    "0000064000000320000001900000000C94330240065CD1D00CA9A3B025D6F780000000000E82EED0" +
                    "0000000008C6889FFFFFFFFFF2100386D656469756D5F7370656E646572320000000080DD62B2210" +
                    "200000000000000000032000000640000003C00000019000000005B01F6300065CD1D00CA9A3B021" +
                    "161DB0000000000BFD1AA010000000020972AFFFFFFFFFF22002C6269675F7370656E64657232000" +
                    "0000000BBC5644304000000000000000000320000006400000046000000190000000000CA9A3B006" +
                    "5CD1D00CA9A3B02413CB00100000000755D34030000000045D165FEFFFFFFFF");
            return result;
        }
    }
