...
namespace XCavatePaseo.NetApi.Generated.Model.xcm.v2.multiasset
{
    ...
    /// <summary>
    /// >> 119 - Variant[xcm.v2.multiasset.Fungibility]
    /// </summary>
    public sealed class EnumFungibility : BaseEnumRust<Fungibility>
    {
        ...
        public EnumFungibility()
        {
				...
				AddTypeDecoder<XCavatePaseo.NetApi.Generated.Model.xcm.v2.multiasset.EnumAssetInstance>(Fungibility.NonFungible);
        }
    }
}
