...
namespace BifrostPolkadot.NetApi.Generated.Model.pallet_token_gateway.types
{
    ...
    /// <summary>
    /// >> 362 - Composite[pallet_token_gateway.types.TeleportParams]
    /// </summary>
    ...
    public sealed class TeleportParams : BaseType
    {
        ...
        /// >> asset_id
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId AssetId { get; set; }
        /// <summary>
        /// >> destination
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Model.ismp.host.EnumStateMachine Destination { get; set; }
        /// <summary>
        /// >> recepient
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Model.primitive_types.H256 Recepient { get; set; }
        /// <summary>
        /// >> amount
        /// </summary>
        ...
        {
            var start = p;
            AssetId = new BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId();
            AssetId.Decode(byteArray, ref p);
            Destination = new BifrostPolkadot.NetApi.Generated.Model.ismp.host.EnumStateMachine();
            Destination.Decode(byteArray, ref p);
            Recepient = new BifrostPolkadot.NetApi.Generated.Model.primitive_types.H256();
