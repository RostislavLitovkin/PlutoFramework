...
namespace BifrostPolkadot.NetApi.Generated.Model.bifrost_farming.rewards
{
    ...
    /// <summary>
    /// >> 926 - Composite[bifrost_farming.rewards.PoolInfo]
    /// </summary>
    ...
    public sealed class PoolInfo : BaseType
    {
        ...
        /// >> tokens_proportion
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Types.Base.BTreeMapT12 TokensProportion { get; set; }
        /// <summary>
        /// >> basic_token
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseTuple<BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId, BifrostPolkadot.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill> BasicToken { get; set; }
        /// <summary>
        /// >> total_shares
        /// </summary>
        ...
        /// >> basic_rewards
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Types.Base.BTreeMapT8 BasicRewards { get; set; }
        /// <summary>
        /// >> rewards
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Types.Base.BTreeMapT13 Rewards { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Model.bifrost_farming.rewards.EnumPoolState State { get; set; }
        /// <summary>
        /// >> keeper
        /// </summary>
        ...
        {
            var start = p;
            TokensProportion = new BifrostPolkadot.NetApi.Generated.Types.Base.BTreeMapT12();
            TokensProportion.Decode(byteArray, ref p);
            BasicToken = new Substrate.NetApi.Model.Types.Base.BaseTuple<BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId, BifrostPolkadot.NetApi.Generated.Model.sp_arithmetic.per_things.Perbill>();
            ...
            BasicRewards = new BifrostPolkadot.NetApi.Generated.Types.Base.BTreeMapT8();
            BasicRewards.Decode(byteArray, ref p);
            Rewards = new BifrostPolkadot.NetApi.Generated.Types.Base.BTreeMapT13();
            Rewards.Decode(byteArray, ref p);
            State = new BifrostPolkadot.NetApi.Generated.Model.bifrost_farming.rewards.EnumPoolState();
