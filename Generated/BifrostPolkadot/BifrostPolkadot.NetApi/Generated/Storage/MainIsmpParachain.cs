...
namespace BifrostPolkadot.NetApi.Generated.Storage
{
    ...
    public sealed class IsmpParachainStorage
    {
        ...
        ///  parachain-system.
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Model.primitive_types.H256> RelayChainStateCommitments(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class IsmpParachainCalls
    {
        ...
        /// </summary>
        public static Method UpdateParachainConsensus(BifrostPolkadot.NetApi.Generated.Model.ismp.messaging.ConsensusMessage data)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(data.Encode());
            return new Method(91, "IsmpParachain", 0, "update_parachain_consensus", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddParachain(Substrate.NetApi.Model.Types.Base.BaseVec<BifrostPolkadot.NetApi.Generated.Model.ismp_parachain.ParachainData> para_ids)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(para_ids.Encode());
            return new Method(91, "IsmpParachain", 1, "add_parachain", byteArray.ToArray());
        }
        ...
        public static Method RemoveParachain(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U32> para_ids)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(para_ids.Encode());
            return new Method(91, "IsmpParachain", 2, "remove_parachain", byteArray.ToArray());
        }
    }
