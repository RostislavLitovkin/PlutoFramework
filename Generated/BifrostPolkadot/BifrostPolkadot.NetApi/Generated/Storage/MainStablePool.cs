...
namespace BifrostPolkadot.NetApi.Generated.Storage
{
    ...
    public sealed class StablePoolCalls
    {
        ...
        /// </summary>
        public static Method CreatePool(Substrate.NetApi.Model.Types.Base.BaseVec<BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId> assets, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U128> precisions, Substrate.NetApi.Model.Types.Primitive.U128 mint_fee, Substrate.NetApi.Model.Types.Primitive.U128 swap_fee, Substrate.NetApi.Model.Types.Primitive.U128 redeem_fee, Substrate.NetApi.Model.Types.Primitive.U128 initial_a, BifrostPolkadot.NetApi.Generated.Model.sp_core.crypto.AccountId32 fee_recipient, BifrostPolkadot.NetApi.Generated.Model.sp_core.crypto.AccountId32 yield_recipient, Substrate.NetApi.Model.Types.Primitive.U128 precision)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ModifyRecipients(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Base.BaseOpt<BifrostPolkadot.NetApi.Generated.Model.sp_core.crypto.AccountId32> fee_recipient, Substrate.NetApi.Model.Types.Base.BaseOpt<BifrostPolkadot.NetApi.Generated.Model.sp_core.crypto.AccountId32> yield_recipient)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(fee_recipient.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method EditTokenRate(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId, Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128>>> token_rate_info)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ConfigVtokenAutoRefresh(BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId vtoken, BifrostPolkadot.NetApi.Generated.Model.sp_arithmetic.per_things.Permill hardcap)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveVtokenAutoRefresh(BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId vtoken)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(vtoken.Encode());
