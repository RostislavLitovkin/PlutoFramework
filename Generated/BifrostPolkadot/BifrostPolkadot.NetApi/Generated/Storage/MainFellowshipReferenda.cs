...
namespace BifrostPolkadot.NetApi.Generated.Storage
{
    ...
    public sealed class FellowshipReferendaStorage
    {
        ...
        public FellowshipReferendaStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipReferenda", "ReferendumInfoFor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(BifrostPolkadot.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipReferenda", "TrackQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(BifrostPolkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT65)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipReferenda", "MetadataOf"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H256)));
        }
        ...
        ///  Information concerning any given referendum.
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo> ReferendumInfoFor(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = FellowshipReferendaStorage.ReferendumInfoForParams(key);
            var result = await _client.GetStorageAsync<BifrostPolkadot.NetApi.Generated.Model.pallet_referenda.types.EnumReferendumInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT65> TrackQueue(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
            string parameters = FellowshipReferendaStorage.TrackQueueParams(key);
            var result = await _client.GetStorageAsync<BifrostPolkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT65>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  large preimages.
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Model.primitive_types.H256> MetadataOf(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class FellowshipReferendaCalls
    {
        ...
        /// </summary>
        public static Method Submit(BifrostPolkadot.NetApi.Generated.Model.bifrost_polkadot_runtime.EnumOriginCaller proposal_origin, BifrostPolkadot.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, BifrostPolkadot.NetApi.Generated.Model.frame_support.traits.schedule.EnumDispatchTime enactment_moment)
        {
            ...
            return new Method(127, "FellowshipReferenda", 0, "submit", byteArray.ToArray());
        }
        ...
        public static Method PlaceDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(127, "FellowshipReferenda", 1, "place_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method RefundDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(127, "FellowshipReferenda", 2, "refund_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method Cancel(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(127, "FellowshipReferenda", 3, "cancel", byteArray.ToArray());
        }
        ...
        public static Method Kill(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(127, "FellowshipReferenda", 4, "kill", byteArray.ToArray());
        }
        ...
        public static Method NudgeReferendum(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(127, "FellowshipReferenda", 5, "nudge_referendum", byteArray.ToArray());
        }
        ...
        public static Method OneFewerDeciding(Substrate.NetApi.Model.Types.Primitive.U16 track)
        {
            ...
            return new Method(127, "FellowshipReferenda", 6, "one_fewer_deciding", byteArray.ToArray());
        }
        ...
        public static Method RefundSubmissionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(127, "FellowshipReferenda", 7, "refund_submission_deposit", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetMetadata(Substrate.NetApi.Model.Types.Primitive.U32 index, Substrate.NetApi.Model.Types.Base.BaseOpt<BifrostPolkadot.NetApi.Generated.Model.primitive_types.H256> maybe_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            byteArray.AddRange(maybe_hash.Encode());
            return new Method(127, "FellowshipReferenda", 8, "set_metadata", byteArray.ToArray());
        }
    }
    ...
    public sealed class FellowshipReferendaConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, BifrostPolkadot.NetApi.Generated.Model.pallet_referenda.types.TrackInfo>> Tracks()
        {
            var result = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, BifrostPolkadot.NetApi.Generated.Model.pallet_referenda.types.TrackInfo>>();
            result.Create("0x2800002863616E646964617465730A00000000407A10F35A000000000000000000000A000000807" +
                    "00000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32301001C6" +
                    "D656D626572730A00000000A0724E1809000000000000000000000A00000080700000320000000A0" +
                    "000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32302002C70726F66696369656" +
                    "E74730A00000000A0724E1809000000000000000000000A00000080700000320000000A000000000" +
                    "0CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32303001C66656C6C6F77730A00000000A" +
                    "0724E1809000000000000000000000A00000080700000320000000A0000000000CA9A3B0065CD1D0" +
                    "0CA9A3B0000CA9A3B0065CD1D0046C32304003873656E696F722066656C6C6F77730A00000000A07" +
                    "24E1809000000000000000000000A00000080700000320000000A0000000000CA9A3B0065CD1D00C" +
                    "A9A3B0000CA9A3B0065CD1D0046C32305001C657870657274730A0000000010A5D4E800000000000" +
                    "000000000000A00000080700000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0" +
                    "065CD1D0046C32306003873656E696F7220657870657274730A0000000010A5D4E80000000000000" +
                    "0000000000A00000080700000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B006" +
                    "5CD1D0046C32307001C6D6173746572730A0000000010A5D4E800000000000000000000000A00000" +
                    "080700000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C323080" +
                    "03873656E696F72206D6173746572730A0000000010A5D4E800000000000000000000000A0000008" +
                    "0700000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C32309003" +
                    "46772616E64206D6173746572730A0000000010A5D4E800000000000000000000000A00000080700" +
                    "000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0065CD1D0046C323");
            return result;
        }
    }
