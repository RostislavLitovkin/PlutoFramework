...
namespace BifrostPolkadot.NetApi.Generated.Storage
{
    ...
    public sealed class TokenConversionStorage
    {
        ...
        public TokenConversionStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TokenConversion", "ExchangeRate"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.I32), typeof(BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeRate)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TokenConversion", "ExchangeFee"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeFee)));
        }
        ...
        /// >> ExchangeRate
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeRate> ExchangeRate(Substrate.NetApi.Model.Types.Primitive.I32 key, string blockhash, CancellationToken token)
        {
            string parameters = TokenConversionStorage.ExchangeRateParams(key);
            var result = await _client.GetStorageAsync<BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeRate>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  exchange fee
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeFee> ExchangeFee(string blockhash, CancellationToken token)
        {
            string parameters = TokenConversionStorage.ExchangeFeeParams();
            var result = await _client.GetStorageAsync<BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeFee>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class TokenConversionCalls
    {
        ...
        /// </summary>
        public static Method VsbondConvertToVstoken(BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId vs_bond_currency_id, Substrate.NetApi.Model.Types.Primitive.U128 vsbond_amount, Substrate.NetApi.Model.Types.Primitive.U128 minimum_vstoken)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VstokenConvertToVsbond(BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId currency_id, Substrate.NetApi.Model.Types.Primitive.U128 vstoken_amount, Substrate.NetApi.Model.Types.Primitive.U128 minimum_vsbond)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetExchangeFee(BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeFee exchange_fee)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetExchangeRate(Substrate.NetApi.Model.Types.Primitive.I32 lease, BifrostPolkadot.NetApi.Generated.Model.bifrost_vstoken_conversion.primitives.VstokenConversionExchangeRate exchange_rate)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class TokenConversionConstants
    {
        ...
        /// >> RelayCurrencyId
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Model.bifrost_primitives.currency.EnumCurrencyId RelayCurrencyId()
        {
        ...
        /// >> VsbondAccount
        /// </summary>
        public BifrostPolkadot.NetApi.Generated.Model.frame_support.PalletId VsbondAccount()
        {
