...
namespace BifrostPolkadot.NetApi.Generated.Storage
{
    ...
    public sealed class ReferendaStorage
    {
        ...
        public ReferendaStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Referenda", "TrackQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(BifrostPolkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31)));
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31> TrackQueue(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
            string parameters = ReferendaStorage.TrackQueueParams(key);
            var result = await _client.GetStorageAsync<BifrostPolkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class ReferendaConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, BifrostPolkadot.NetApi.Generated.Model.pallet_referenda.types.TrackInfo>> Tracks()
        {
            ...
            result.Create("0x20000010726F6F74010000000000C52EBCA2B1000000000000000000B0040000801303004038000" +
                    ...
                    "00000003200000080130300320000003200000002EC972510000000007B573C170000000042392F1" +
                    "200000000024616000000000000672E000000000000BA1631010000000002004066656C6C6F77736" +
                    "869705F61646D696E0A0000000040F09BBCE108000000000000000000B0040000801303000807000" +
                    "06400000000C94330240065CD1D00CA9A3B025D6F780000000000E82EED00000000008C6889FFFFF" +
                    ...
                    "0000000E82EED00000000008C6889FFFFFFFFFF0400447265666572656E64756D5F6B696C6C6572E" +
                    "8030000008062175ED158000000000000000000B004000080130300080700006400000000C943302" +
                    "40065CD1D00CA9A3B025D6F780000000000E82EED00000000008C6889FFFFFFFFFF0A00386C69717" +
                    "569645F7374616B696E670A0000000040F09BBCE108000000000000000000B004000080130300080" +
                    "70000640000000267F0640400000000DD46C607000000009141EA1900000000026F5642000000000" +
                    "0918A830000000000B73ABEFFFFFFFFFF0C002873616C705F61646D696E0A0000000040F09BBCE10" +
                    "8000000000000000000960000008013030058020000640000000267F0640400000000DD46C607000" +
                    "000009141EA1900000000026F56420000000000918A830000000000B73ABEFFFFFFFFFF0D0038747" +
                    "26561737572795F7370656E646400000000406352BFC601000000000000000000B00400008013030" +
                    "00807000064000000005B01F6300065CD1D00CA9A3B021161DB0000000000BFD1AA0100000000209" +
                    "72AFFFFFFFFFF");
            return result;
        }
    }
