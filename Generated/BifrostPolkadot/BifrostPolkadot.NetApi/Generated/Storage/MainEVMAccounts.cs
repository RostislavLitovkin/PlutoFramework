...
namespace BifrostPolkadot.NetApi.Generated.Storage
{
    ...
    public sealed class EVMAccountsStorage
    {
        ...
        public EVMAccountsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EVMAccounts", "AccountExtension"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H160), typeof(BifrostPolkadot.NetApi.Generated.Types.Base.Arr12U8)));
        ...
        /// </summary>
        public static string AccountExtensionParams(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H160 key)
        {
        ...
        ///  Maps an EVM address to the last 12 bytes of a substrate account.
        /// </summary>
        public async Task<BifrostPolkadot.NetApi.Generated.Types.Base.Arr12U8> AccountExtension(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H160 key, string blockhash, CancellationToken token)
        {
            string parameters = EVMAccountsStorage.AccountExtensionParams(key);
            var result = await _client.GetStorageAsync<BifrostPolkadot.NetApi.Generated.Types.Base.Arr12U8>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ContractDeployerParams(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H160 key)
        {
        ...
        ///  Whitelisted addresses that are allowed to deploy smart contracts.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> ContractDeployer(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H160 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class EVMAccountsCalls
    {
        ...
        public static Method BindEvmAddress()
        {
            ...
            return new Method(69, "EVMAccounts", 0, "bind_evm_address", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddContractDeployer(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H160 address)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(address.Encode());
            return new Method(69, "EVMAccounts", 1, "add_contract_deployer", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveContractDeployer(BifrostPolkadot.NetApi.Generated.Model.primitive_types.H160 address)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(address.Encode());
            return new Method(69, "EVMAccounts", 2, "remove_contract_deployer", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(69, "EVMAccounts", 3, "renounce_contract_deployer", byteArray.ToArray());
        }
    }
