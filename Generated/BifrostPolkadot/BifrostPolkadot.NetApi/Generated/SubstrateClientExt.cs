...
using BifrostPolkadot.NetApi.Generated.Storage;
...
namespace BifrostPolkadot.NetApi.Generated
{
    ...
    public sealed class SubstrateClientExt : Substrate.NetApi.SubstrateClient
    {
        ...
        /// <summary>
        /// BbBNCStorage storage calls.
        /// </summary>
        public BbBNCStorage BbBNCStorage;
        ...
        /// <summary>
        /// SlpV2Storage storage calls.
        /// </summary>
        public SlpV2Storage SlpV2Storage;
                ...
                base(uri, chargeType)
        {
            ...
            this.BbBNCStorage = new BbBNCStorage(this);
            ...
            this.SlpV2Storage = new SlpV2Storage(this);
        }
    }
}
