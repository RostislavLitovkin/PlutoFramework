...
namespace PolkadotPeople.NetApi.Generated.Storage
{
    ...
    public sealed class MultiBlockMigrationsStorage
    {
        ...
        ///  `None` indicates that no migration is running.
        /// </summary>
        public async Task<PolkadotPeople.NetApi.Generated.Model.pallet_migrations.EnumMigrationCursor> Cursor(string blockhash, CancellationToken token)
        {
            string parameters = MultiBlockMigrationsStorage.CursorParams();
            var result = await _client.GetStorageAsync<PolkadotPeople.NetApi.Generated.Model.pallet_migrations.EnumMigrationCursor>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class MultiBlockMigrationsCalls
    {
        ...
        /// </summary>
        public static Method ForceSetCursor(Substrate.NetApi.Model.Types.Base.BaseOpt<PolkadotPeople.NetApi.Generated.Model.pallet_migrations.EnumMigrationCursor> cursor)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(cursor.Encode());
            return new Method(4, "MultiBlockMigrations", 0, "force_set_cursor", byteArray.ToArray());
        }
        ...
        public static Method ForceSetActiveCursor(Substrate.NetApi.Model.Types.Primitive.U32 index, Substrate.NetApi.Model.Types.Base.BaseOpt<PolkadotPeople.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> inner_cursor, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> started_at)
        {
            ...
            return new Method(4, "MultiBlockMigrations", 1, "force_set_active_cursor", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(4, "MultiBlockMigrations", 2, "force_onboard_mbms", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ClearHistoric(PolkadotPeople.NetApi.Generated.Model.pallet_migrations.EnumHistoricCleanupSelector selector)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(selector.Encode());
            return new Method(4, "MultiBlockMigrations", 3, "clear_historic", byteArray.ToArray());
        }
    }
