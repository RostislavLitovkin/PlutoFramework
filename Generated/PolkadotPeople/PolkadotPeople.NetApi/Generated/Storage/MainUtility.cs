...
namespace PolkadotPeople.NetApi.Generated.Storage
{
    ...
    public sealed class UtilityCalls
    {
        ...
        /// </summary>
        public static Method Batch(Substrate.NetApi.Model.Types.Base.BaseVec<PolkadotPeople.NetApi.Generated.Model.people_polkadot_runtime.EnumRuntimeCall> calls)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AsDerivative(Substrate.NetApi.Model.Types.Primitive.U16 index, PolkadotPeople.NetApi.Generated.Model.people_polkadot_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method BatchAll(Substrate.NetApi.Model.Types.Base.BaseVec<PolkadotPeople.NetApi.Generated.Model.people_polkadot_runtime.EnumRuntimeCall> calls)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(calls.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DispatchAs(PolkadotPeople.NetApi.Generated.Model.people_polkadot_runtime.EnumOriginCaller as_origin, PolkadotPeople.NetApi.Generated.Model.people_polkadot_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceBatch(Substrate.NetApi.Model.Types.Base.BaseVec<PolkadotPeople.NetApi.Generated.Model.people_polkadot_runtime.EnumRuntimeCall> calls)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(calls.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method WithWeight(PolkadotPeople.NetApi.Generated.Model.people_polkadot_runtime.EnumRuntimeCall call, PolkadotPeople.NetApi.Generated.Model.sp_weights.weight_v2.Weight weight)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call.Encode());
