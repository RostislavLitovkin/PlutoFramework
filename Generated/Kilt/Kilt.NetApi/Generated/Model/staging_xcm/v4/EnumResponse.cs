...
namespace Kilt.NetApi.Generated.Model.staging_xcm.v4
{
    ...
    /// <summary>
    /// >> 190 - Variant[staging_xcm.v4.Response]
    /// </summary>
    public sealed class EnumResponse : BaseEnumRust<Response>
    {
        ...
        public EnumResponse()
        {
				...
				AddTypeDecoder<Kilt.NetApi.Generated.Model.staging_xcm.v4.asset.Assets>(Response.Assets);
				...
				AddTypeDecoder<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12>(Response.PalletsInfo);
