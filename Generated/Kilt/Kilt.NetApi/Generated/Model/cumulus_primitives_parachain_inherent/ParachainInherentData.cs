...
namespace Kilt.NetApi.Generated.Model.cumulus_primitives_parachain_inherent
{
    
    
    /// <summary>
    /// >> 383 - Composite[cumulus_primitives_parachain_inherent.ParachainInherentData]
    /// </summary>
    ...
    public sealed class ParachainInherentData : BaseType
    {
        ...
        /// >> validation_data
        /// </summary>
        public Kilt.NetApi.Generated.Model.polkadot_primitives.v6.PersistedValidationData ValidationData { get; set; }
        /// <summary>
        /// >> relay_chain_state
        /// </summary>
        public Kilt.NetApi.Generated.Model.sp_trie.storage_proof.StorageProof RelayChainState { get; set; }
        /// <summary>
        /// >> downward_messages
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Kilt.NetApi.Generated.Model.polkadot_core_primitives.InboundDownwardMessage> DownwardMessages { get; set; }
        /// <summary>
        /// >> horizontal_messages
        /// </summary>
        ...
        {
            var start = p;
            ValidationData = new Kilt.NetApi.Generated.Model.polkadot_primitives.v6.PersistedValidationData();
            ValidationData.Decode(byteArray, ref p);
            RelayChainState = new Kilt.NetApi.Generated.Model.sp_trie.storage_proof.StorageProof();
