...
namespace Kilt.NetApi.Generated.Storage
{
    ...
    public sealed class DemocracyStorage
    {
        ...
        public DemocracyStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Democracy", "PublicProps"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Democracy", "DepositOf"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31, Substrate.NetApi.Model.Types.Primitive.U128>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Democracy", "ReferendumInfoOf"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Kilt.NetApi.Generated.Model.pallet_democracy.types.EnumReferendumInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Democracy", "VotingOf"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Kilt.NetApi.Generated.Model.pallet_democracy.vote.EnumVoting)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Democracy", "Blacklist"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Kilt.NetApi.Generated.Model.primitive_types.H256), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Democracy", "MetadataOf"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Kilt.NetApi.Generated.Model.pallet_democracy.types.EnumMetadataOwner), typeof(Kilt.NetApi.Generated.Model.primitive_types.H256)));
        }
        ...
        ///  The public proposals. Unsorted. The second item is the proposal.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21> PublicProps(string blockhash, CancellationToken token)
        {
            string parameters = DemocracyStorage.PublicPropsParams();
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: Safe, as increasing integer keys are safe.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31, Substrate.NetApi.Model.Types.Primitive.U128>> DepositOf(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = DemocracyStorage.DepositOfParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31, Substrate.NetApi.Model.Types.Primitive.U128>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: SAFE as indexes are not under an attacker���s control.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.pallet_democracy.types.EnumReferendumInfo> ReferendumInfoOf(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = DemocracyStorage.ReferendumInfoOfParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.pallet_democracy.types.EnumReferendumInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string VotingOfParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE as `AccountId`s are crypto hashes anyway.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.pallet_democracy.vote.EnumVoting> VotingOf(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = DemocracyStorage.VotingOfParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.pallet_democracy.vote.EnumVoting>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  - `PublicProps` is empty.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Kilt.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded, Kilt.NetApi.Generated.Model.pallet_democracy.vote_threshold.EnumVoteThreshold>> NextExternal(string blockhash, CancellationToken token)
        {
            string parameters = DemocracyStorage.NextExternalParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Kilt.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded, Kilt.NetApi.Generated.Model.pallet_democracy.vote_threshold.EnumVoteThreshold>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string BlacklistParams(Kilt.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  (until when it may not be resubmitted) and who vetoed it.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31>> Blacklist(Kilt.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = DemocracyStorage.BlacklistParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string CancellationsParams(Kilt.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  Record of all proposals that have been subject to emergency cancellation.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> Cancellations(Kilt.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
        ...
        ///  large preimages.
        /// </summary>
        public static string MetadataOfParams(Kilt.NetApi.Generated.Model.pallet_democracy.types.EnumMetadataOwner key)
        {
        ...
        ///  large preimages.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.primitive_types.H256> MetadataOf(Kilt.NetApi.Generated.Model.pallet_democracy.types.EnumMetadataOwner key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class DemocracyCalls
    {
        ...
        /// </summary>
        public static Method Propose(Kilt.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> value)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Vote(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> ref_index, Kilt.NetApi.Generated.Model.pallet_democracy.vote.EnumAccountVote vote)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ExternalPropose(Kilt.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded proposal)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ExternalProposeMajority(Kilt.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded proposal)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ExternalProposeDefault(Kilt.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded proposal)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method FastTrack(Kilt.NetApi.Generated.Model.primitive_types.H256 proposal_hash, Substrate.NetApi.Model.Types.Primitive.U64 voting_period, Substrate.NetApi.Model.Types.Primitive.U64 delay)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VetoExternal(Kilt.NetApi.Generated.Model.primitive_types.H256 proposal_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Delegate(Kilt.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress to, Kilt.NetApi.Generated.Model.pallet_democracy.conviction.EnumConviction conviction, Substrate.NetApi.Model.Types.Primitive.U128 balance)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Unlock(Kilt.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveOtherVote(Kilt.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target, Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
            byteArray.AddRange(index.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Blacklist(Kilt.NetApi.Generated.Model.primitive_types.H256 proposal_hash, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> maybe_ref_index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_hash.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetMetadata(Kilt.NetApi.Generated.Model.pallet_democracy.types.EnumMetadataOwner owner, Substrate.NetApi.Model.Types.Base.BaseOpt<Kilt.NetApi.Generated.Model.primitive_types.H256> maybe_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
