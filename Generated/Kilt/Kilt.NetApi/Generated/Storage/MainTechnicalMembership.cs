...
namespace Kilt.NetApi.Generated.Storage
{
    ...
    public sealed class TechnicalMembershipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalMembership", "Members"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalMembership", "Prime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35> Members(string blockhash, CancellationToken token)
        {
            string parameters = TechnicalMembershipStorage.MembersParams();
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35>(parameters, blockhash, token);
            return result;
        }
