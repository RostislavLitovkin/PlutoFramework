...
namespace Kilt.NetApi.Generated.Storage
{
    ...
    public sealed class ParachainStakingStorage
    {
        ...
        public ParachainStakingStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "Round"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.parachain_staking.types.RoundInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "LastDelegation"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Kilt.NetApi.Generated.Model.parachain_staking.types.DelegationCounter)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "DelegatorState"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Kilt.NetApi.Generated.Model.parachain_staking.types.Stake)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "CandidatePool"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Kilt.NetApi.Generated.Model.parachain_staking.types.Candidate)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "TotalCollatorStake"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.parachain_staking.types.TotalStake)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "TopCandidates"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.parachain_staking.set.OrderedSetT2)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "InflationConfig"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.parachain_staking.inflation.InflationInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "Unstaking"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Kilt.NetApi.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "BlocksAuthored"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U64)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "Rewards"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U128)));
        ...
        ///  Current round number and next round scheduled transition.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.parachain_staking.types.RoundInfo> Round(string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.RoundParams();
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.parachain_staking.types.RoundInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LastDelegationParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  session in which they (re-)delegated.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.parachain_staking.types.DelegationCounter> LastDelegation(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.LastDelegationParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.parachain_staking.types.DelegationCounter>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string DelegatorStateParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  It maps from an account to its delegation details.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.parachain_staking.types.Stake> DelegatorState(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.DelegatorStateParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.parachain_staking.types.Stake>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string CandidatePoolParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Moreover, it counts the number of candidates.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.parachain_staking.types.Candidate> CandidatePool(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.CandidatePoolParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.parachain_staking.types.Candidate>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  non collating candidates is not included in `TotalCollatorStake`.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.parachain_staking.types.TotalStake> TotalCollatorStake(string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.TotalCollatorStakeParams();
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.parachain_staking.types.TotalStake>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  stake.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.parachain_staking.set.OrderedSetT2> TopCandidates(string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.TopCandidatesParams();
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.parachain_staking.set.OrderedSetT2>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Inflation configuration.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.parachain_staking.inflation.InflationInfo> InflationConfig(string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.InflationConfigParams();
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.parachain_staking.inflation.InflationInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  blocks.
        /// </summary>
        public static string UnstakingParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  blocks.
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT1> Unstaking(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.UnstakingParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT1>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string BlocksAuthoredParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  `note_author` hook when authoring a block .
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> BlocksAuthored(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string BlocksRewardedParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  `inc_delegator_rewards` or updating the `InflationInfo`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> BlocksRewarded(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string RewardsParams(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  It maps from accounts to their total rewards since the last payout.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> Rewards(Kilt.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class ParachainStakingCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceRemoveCandidate(Kilt.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress collator)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ExecuteLeaveCandidates(Kilt.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress collator)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(collator.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method JoinDelegators(Kilt.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress collator, Substrate.NetApi.Model.Types.Primitive.U128 amount)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(collator.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UnlockUnstaked(Kilt.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class ParachainStakingConstants
    {
        ...
        ///  stake.
        /// </summary>
        public Kilt.NetApi.Generated.Model.sp_arithmetic.per_things.Perquintill NetworkRewardRate()
        {
            var result = new Kilt.NetApi.Generated.Model.sp_arithmetic.per_things.Perquintill();
