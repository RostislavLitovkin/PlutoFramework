...
namespace Kilt.NetApi.Generated.Storage
{
    ...
    public sealed class IsmpStorage
    {
        ...
        public IsmpStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "StateCommitments"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineHeight), typeof(Kilt.NetApi.Generated.Model.ismp.consensus.StateCommitment)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "ConsensusStates"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Types.Base.Arr4U8), typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "ConsensusStateClient"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Kilt.NetApi.Generated.Types.Base.Arr4U8), typeof(Kilt.NetApi.Generated.Types.Base.Arr4U8)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "UnbondingPeriod"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Kilt.NetApi.Generated.Types.Base.Arr4U8), typeof(Substrate.NetApi.Model.Types.Primitive.U64)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "ChallengePeriod"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineId), typeof(Substrate.NetApi.Model.Types.Primitive.U64)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "FrozenConsensusClients"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Kilt.NetApi.Generated.Types.Base.Arr4U8), typeof(Substrate.NetApi.Model.Types.Primitive.Bool)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "ConsensusClientUpdateTime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Types.Base.Arr4U8), typeof(Substrate.NetApi.Model.Types.Primitive.U64)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "StateMachineUpdateTime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineHeight), typeof(Substrate.NetApi.Model.Types.Primitive.U64)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ismp", "ChildTrieRoot"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Kilt.NetApi.Generated.Model.primitive_types.H256)));
        }
        ...
        /// </summary>
        public static string StateCommitmentsParams(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineHeight key)
        {
        ...
        ///  commitments end up here after they are successfully verified by a `ConsensusClient`
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.ismp.consensus.StateCommitment> StateCommitments(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineHeight key, string blockhash, CancellationToken token)
        {
            string parameters = IsmpStorage.StateCommitmentsParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Model.ismp.consensus.StateCommitment>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ConsensusStatesParams(Kilt.NetApi.Generated.Types.Base.Arr4U8 key)
        {
        ...
        ///  Holds a map of consensus state identifiers to their consensus state.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> ConsensusStates(Kilt.NetApi.Generated.Types.Base.Arr4U8 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string ConsensusStateClientParams(Kilt.NetApi.Generated.Types.Base.Arr4U8 key)
        {
        ...
        ///  A mapping of consensus state identifier to it's associated consensus client identifier
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Types.Base.Arr4U8> ConsensusStateClient(Kilt.NetApi.Generated.Types.Base.Arr4U8 key, string blockhash, CancellationToken token)
        {
            string parameters = IsmpStorage.ConsensusStateClientParams(key);
            var result = await _client.GetStorageAsync<Kilt.NetApi.Generated.Types.Base.Arr4U8>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string UnbondingPeriodParams(Kilt.NetApi.Generated.Types.Base.Arr4U8 key)
        {
        ...
        ///  A mapping of consensus state identifiers to their unbonding periods
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> UnbondingPeriod(Kilt.NetApi.Generated.Types.Base.Arr4U8 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string ChallengePeriodParams(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineId key)
        {
        ...
        ///  A mapping of state machine Ids to their challenge periods
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> ChallengePeriod(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineId key, string blockhash, CancellationToken token)
        {
        ...
        ///  behaviour
        /// </summary>
        public static string FrozenConsensusClientsParams(Kilt.NetApi.Generated.Types.Base.Arr4U8 key)
        {
        ...
        ///  behaviour
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> FrozenConsensusClients(Kilt.NetApi.Generated.Types.Base.Arr4U8 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string LatestStateMachineHeightParams(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineId key)
        {
        ...
        ///  The latest verified height for a state machine
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> LatestStateMachineHeight(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineId key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string ConsensusClientUpdateTimeParams(Kilt.NetApi.Generated.Types.Base.Arr4U8 key)
        {
        ...
        ///  Used in ensuring that the configured challenge period elapses.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> ConsensusClientUpdateTime(Kilt.NetApi.Generated.Types.Base.Arr4U8 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Used in ensuring that the configured challenge period elapses.
        /// </summary>
        public static string StateMachineUpdateTimeParams(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineHeight key)
        {
        ...
        ///  Used in ensuring that the configured challenge period elapses.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> StateMachineUpdateTime(Kilt.NetApi.Generated.Model.ismp.consensus.StateMachineHeight key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string RespondedParams(Kilt.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  The key is the request commitment
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> Responded(Kilt.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
        ...
        ///  The child trie root of messages
        /// </summary>
        public async Task<Kilt.NetApi.Generated.Model.primitive_types.H256> ChildTrieRoot(string blockhash, CancellationToken token)
        {
    ...
    public sealed class IsmpCalls
    {
        ...
        /// </summary>
        public static Method HandleUnsigned(Substrate.NetApi.Model.Types.Base.BaseVec<Kilt.NetApi.Generated.Model.ismp.messaging.EnumMessage> messages)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CreateConsensusClient(Kilt.NetApi.Generated.Model.ismp.messaging.CreateConsensusState message)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateConsensusState(Kilt.NetApi.Generated.Model.pallet_ismp.utils.UpdateConsensusState message)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(message.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method FundMessage(Kilt.NetApi.Generated.Model.pallet_ismp.utils.FundMessageParams message)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(message.Encode());
