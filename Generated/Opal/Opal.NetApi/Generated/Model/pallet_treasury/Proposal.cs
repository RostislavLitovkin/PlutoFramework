...
namespace Opal.NetApi.Generated.Model.pallet_treasury
{
    
    
    /// <summary>
    /// >> 529 - Composite[pallet_treasury.Proposal]
    /// </summary>
    ...
    public sealed class Proposal : BaseType
    {
        ...
        /// >> proposer
        /// </summary>
        public Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 Proposer { get; set; }
        /// <summary>
        /// >> value
        /// </summary>
        ...
        /// >> beneficiary
        /// </summary>
        public Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 Beneficiary { get; set; }
        /// <summary>
        /// >> bond
        /// </summary>
        ...
        {
            var start = p;
            Proposer = new Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32();
            Proposer.Decode(byteArray, ref p);
            Value = new Substrate.NetApi.Model.Types.Primitive.U128();
            Value.Decode(byteArray, ref p);
            Beneficiary = new Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32();
