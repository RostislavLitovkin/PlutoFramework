...
namespace Opal.NetApi.Generated.Model.ethereum.transaction.legacy
{
    ...
    /// <summary>
    /// >> 403 - Composite[ethereum.transaction.legacy.TransactionSignature]
    /// </summary>
    ...
    public sealed class TransactionSignature : BaseType
    {
        ...
        /// >> v
        /// </summary>
        public Opal.NetApi.Generated.Model.ethereum.transaction.legacy.TransactionRecoveryId V { get; set; }
        /// <summary>
        /// >> r
        /// </summary>
        ...
        {
            var start = p;
            V = new Opal.NetApi.Generated.Model.ethereum.transaction.legacy.TransactionRecoveryId();
