...
namespace Opal.NetApi.Generated.Model.cumulus_primitives_core
{
    ...
    /// <summary>
    /// >> 325 - Variant[cumulus_primitives_core.AggregateMessageOrigin]
    /// </summary>
    public sealed class EnumAggregateMessageOrigin : BaseEnumRust<AggregateMessageOrigin>
    {
        ...
        public EnumAggregateMessageOrigin()
        {
				...
				AddTypeDecoder<Opal.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id>(AggregateMessageOrigin.Sibling);
        }
    }
}
