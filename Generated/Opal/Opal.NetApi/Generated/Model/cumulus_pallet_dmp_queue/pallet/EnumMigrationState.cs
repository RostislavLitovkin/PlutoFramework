...
namespace Opal.NetApi.Generated.Model.cumulus_pallet_dmp_queue.pallet
{
    ...
    /// <summary>
    /// >> 653 - Variant[cumulus_pallet_dmp_queue.pallet.MigrationState]
    /// </summary>
    public sealed class EnumMigrationState : BaseEnumRust<MigrationState>
    {
        ...
        public EnumMigrationState()
        {
				...
				AddTypeDecoder<Substrate.NetApi.Model.Types.Base.BaseOpt<Opal.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT49>>(MigrationState.StartedCleanup);
