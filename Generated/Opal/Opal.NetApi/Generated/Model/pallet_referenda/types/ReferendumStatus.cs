...
namespace Opal.NetApi.Generated.Model.pallet_referenda.types
{
    ...
    /// <summary>
    /// >> 594 - Composite[pallet_referenda.types.ReferendumStatus]
    /// </summary>
    ...
    public sealed class ReferendumStatus : BaseType
    {
        ...
        /// >> origin
        /// </summary>
        public Opal.NetApi.Generated.Model.opal_runtime.EnumOriginCaller Origin { get; set; }
        /// <summary>
        /// >> proposal
        /// </summary>
        public Opal.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded Proposal { get; set; }
        /// <summary>
        /// >> enactment
        /// </summary>
        public Opal.NetApi.Generated.Model.frame_support.traits.schedule.EnumDispatchTime Enactment { get; set; }
        /// <summary>
        /// >> submitted
        /// </summary>
        ...
        /// >> submission_deposit
        /// </summary>
        public Opal.NetApi.Generated.Model.pallet_referenda.types.Deposit SubmissionDeposit { get; set; }
        /// <summary>
        /// >> decision_deposit
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Opal.NetApi.Generated.Model.pallet_referenda.types.Deposit> DecisionDeposit { get; set; }
        /// <summary>
        /// >> deciding
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Opal.NetApi.Generated.Model.pallet_referenda.types.DecidingStatus> Deciding { get; set; }
        /// <summary>
        /// >> tally
        /// </summary>
        public Opal.NetApi.Generated.Model.pallet_ranked_collective.Tally Tally { get; set; }
        /// <summary>
        /// >> in_queue
        /// </summary>
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Origin = new Opal.NetApi.Generated.Model.opal_runtime.EnumOriginCaller();
            Origin.Decode(byteArray, ref p);
            Proposal = new Opal.NetApi.Generated.Model.frame_support.traits.preimages.EnumBounded();
            Proposal.Decode(byteArray, ref p);
            Enactment = new Opal.NetApi.Generated.Model.frame_support.traits.schedule.EnumDispatchTime();
            Enactment.Decode(byteArray, ref p);
            Submitted = new Substrate.NetApi.Model.Types.Primitive.U32();
            Submitted.Decode(byteArray, ref p);
            SubmissionDeposit = new Opal.NetApi.Generated.Model.pallet_referenda.types.Deposit();
            SubmissionDeposit.Decode(byteArray, ref p);
            DecisionDeposit = new Substrate.NetApi.Model.Types.Base.BaseOpt<Opal.NetApi.Generated.Model.pallet_referenda.types.Deposit>();
            DecisionDeposit.Decode(byteArray, ref p);
            Deciding = new Substrate.NetApi.Model.Types.Base.BaseOpt<Opal.NetApi.Generated.Model.pallet_referenda.types.DecidingStatus>();
            Deciding.Decode(byteArray, ref p);
            Tally = new Opal.NetApi.Generated.Model.pallet_ranked_collective.Tally();
