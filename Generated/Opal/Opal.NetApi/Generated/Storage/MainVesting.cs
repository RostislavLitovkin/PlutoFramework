...
namespace Opal.NetApi.Generated.Storage
{
    ...
    public sealed class VestingStorage
    {
        ...
        /// </summary>
        public static string VestingSchedulesParams(Opal.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
    ...
    public sealed class VestingCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VestedTransfer(Opal.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress dest, Opal.NetApi.Generated.Model.orml_vesting.VestingSchedule schedule)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateVestingSchedules(Opal.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who, Substrate.NetApi.Model.Types.Base.BaseVec<Opal.NetApi.Generated.Model.orml_vesting.VestingSchedule> vesting_schedules)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ClaimFor(Opal.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress dest)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
