...
namespace Hydration.NetApi.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 552 - Composite[pallet_identity.types.RegistrarInfo]
    /// </summary>
    ...
    public sealed class RegistrarInfo : BaseType
    {
        ...
        /// >> account
        /// </summary>
        public Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 Account { get; set; }
        /// <summary>
        /// >> fee
        /// </summary>
        ...
        {
            var start = p;
            Account = new Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32();
