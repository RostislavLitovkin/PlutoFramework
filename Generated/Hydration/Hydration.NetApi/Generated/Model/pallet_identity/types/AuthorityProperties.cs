...
namespace Hydration.NetApi.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 547 - Composite[pallet_identity.types.AuthorityProperties]
    /// </summary>
    ...
    public sealed class AuthorityProperties : BaseType
    {
        ...
        /// >> suffix
        /// </summary>
        public Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 Suffix { get; set; }
        /// <summary>
        /// >> allocation
        /// </summary>
        ...
        {
            var start = p;
            Suffix = new Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32();
