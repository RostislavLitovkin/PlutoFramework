...
namespace Hydration.NetApi.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 610 - Composite[pallet_identity.types.AuthorityProperties]
    /// </summary>
    ...
    public sealed class AuthorityProperties : BaseType
    {
        ...
        /// >> account_id
        /// </summary>
        public Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 AccountId { get; set; }
        /// <summary>
        /// >> allocation
        /// </summary>
        ...
        {
            var start = p;
            AccountId = new Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32();
