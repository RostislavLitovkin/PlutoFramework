...
namespace Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.pallet
{
    ...
    /// <summary>
    /// >> 464 - Variant[cumulus_pallet_parachain_system.pallet.Event]
    /// The `Event` enum of this pallet
    /// </summary>
    public sealed class EnumEvent : BaseEnumRust<Event>
    {
        ...
        public EnumEvent()
        {
				...
				AddTypeDecoder<BaseTuple<Hydration.NetApi.Generated.Model.sp_weights.weight_v2.Weight, Hydration.NetApi.Generated.Model.primitive_types.H256>>(Event.DownwardMessagesProcessed);
				AddTypeDecoder<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Types.Base.Arr32U8>>(Event.UpwardMessageSent);
        }
    }
}
