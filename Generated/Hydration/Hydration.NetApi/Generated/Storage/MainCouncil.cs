...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class CouncilStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Proposals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Members"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Council", "Prime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32)));
        }
    ...
    public sealed class CouncilCalls
    {
        ...
        public static Method SetMembers(Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32> new_members, Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32> prime, Substrate.NetApi.Model.Types.Primitive.U32 old_count)
        {
            ...
            return new Method(23, "Council", 0, "set_members", byteArray.ToArray());
        }
        ...
        public static Method Execute(Hydration.NetApi.Generated.Model.hydradx_runtime.EnumRuntimeCall proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            ...
            return new Method(23, "Council", 1, "execute", byteArray.ToArray());
        }
        ...
        public static Method Propose(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> threshold, Hydration.NetApi.Generated.Model.hydradx_runtime.EnumRuntimeCall proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            ...
            byteArray.AddRange(proposal.Encode());
            byteArray.AddRange(length_bound.Encode());
            return new Method(23, "Council", 2, "propose", byteArray.ToArray());
        }
        ...
        public static Method Vote(Hydration.NetApi.Generated.Model.primitive_types.H256 proposal, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Substrate.NetApi.Model.Types.Primitive.Bool approve)
        {
            ...
            return new Method(23, "Council", 3, "vote", byteArray.ToArray());
        }
        ...
        public static Method DisapproveProposal(Hydration.NetApi.Generated.Model.primitive_types.H256 proposal_hash)
        {
            ...
            return new Method(23, "Council", 5, "disapprove_proposal", byteArray.ToArray());
        }
        ...
        public static Method Close(Hydration.NetApi.Generated.Model.primitive_types.H256 proposal_hash, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Hydration.NetApi.Generated.Model.sp_weights.weight_v2.Weight proposal_weight_bound, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            ...
            byteArray.AddRange(length_bound.Encode());
            return new Method(23, "Council", 6, "close", byteArray.ToArray());
        }
    }
