...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class CollatorSelectionStorage
    {
        ...
        public CollatorSelectionStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "CandidateList"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT59)));
        ...
        ///  recently updated is considered greater.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT59> CandidateList(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.CandidateListParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT59>(parameters, blockhash, token);
            return result;
        }
