...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class CollatorSelectionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "Invulnerables"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT57)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "CandidateList"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT74)));
        ...
        ///  The invulnerable, permissioned collators. This list must be sorted.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT57> Invulnerables(string blockhash, CancellationToken token)
        {
        ...
        ///  recently updated is considered greater.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT74> CandidateList(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.CandidateListParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT74>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LastAuthoredBlockParams(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Last block authored by collator.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LastAuthoredBlock(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class CollatorSelectionCalls
    {
        ...
        /// </summary>
        public static Method SetInvulnerables(Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32> @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
            return new Method(163, "CollatorSelection", 0, "set_invulnerables", byteArray.ToArray());
        }
        ...
        public static Method SetDesiredCandidates(Substrate.NetApi.Model.Types.Primitive.U32 max)
        {
            ...
            return new Method(163, "CollatorSelection", 1, "set_desired_candidates", byteArray.ToArray());
        }
        ...
        public static Method SetCandidacyBond(Substrate.NetApi.Model.Types.Primitive.U128 bond)
        {
            ...
            return new Method(163, "CollatorSelection", 2, "set_candidacy_bond", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(163, "CollatorSelection", 3, "register_as_candidate", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(163, "CollatorSelection", 4, "leave_intent", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddInvulnerable(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
            return new Method(163, "CollatorSelection", 5, "add_invulnerable", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveInvulnerable(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method TakeCandidateSlot(Substrate.NetApi.Model.Types.Primitive.U128 deposit, Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class CollatorSelectionConstants
    {
        ...
        /// </summary>
        public Hydration.NetApi.Generated.Model.frame_support.PalletId PotId()
        {
        ...
        /// </summary>
        public Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 pot_account()
        {
