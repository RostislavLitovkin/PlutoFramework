...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class IdentityStorage
    {
        ...
        /// </summary>
        public static string IdentityOfParams(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        /// </summary>
        public static string SuperOfParams(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  context. If the account is not some other account's sub-identity, then just `None`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32, Hydration.NetApi.Generated.Model.pallet_identity.types.EnumData>> SuperOf(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = IdentityStorage.SuperOfParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32, Hydration.NetApi.Generated.Model.pallet_identity.types.EnumData>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: OK ��� `AccountId` is a secure hash.
        /// </summary>
        public static string SubsOfParams(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        /// </summary>
        public static string PendingUsernamesParams(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT1 key)
        {
    ...
    public sealed class IdentityCalls
    {
        ...
        /// </summary>
        public static Method AddRegistrar(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 account)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(account.Encode());
            return new Method(17, "Identity", 0, "add_registrar", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method SetIdentity(Hydration.NetApi.Generated.Model.pallet_identity.legacy.IdentityInfo info)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(info.Encode());
            return new Method(17, "Identity", 1, "set_identity", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method SetSubs(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32, Hydration.NetApi.Generated.Model.pallet_identity.types.EnumData>> subs)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(subs.Encode());
            return new Method(17, "Identity", 2, "set_subs", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(17, "Identity", 3, "clear_identity", byteArray.ToArray());
        }
        ...
        public static Method RequestJudgement(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> reg_index, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> max_fee)
        {
            ...
            return new Method(17, "Identity", 4, "request_judgement", byteArray.ToArray());
        }
        ...
        public static Method CancelRequest(Substrate.NetApi.Model.Types.Primitive.U32 reg_index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(reg_index.Encode());
            return new Method(17, "Identity", 5, "cancel_request", byteArray.ToArray());
        }
        ...
        public static Method SetFee(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> fee)
        {
            ...
            return new Method(17, "Identity", 6, "set_fee", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method SetAccountId(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            byteArray.AddRange(@new.Encode());
            return new Method(17, "Identity", 7, "set_account_id", byteArray.ToArray());
        }
        ...
        public static Method SetFields(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Substrate.NetApi.Model.Types.Primitive.U64 fields)
        {
            ...
            return new Method(17, "Identity", 8, "set_fields", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method ProvideJudgement(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> reg_index, Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 target, Hydration.NetApi.Generated.Model.pallet_identity.types.EnumJudgement judgement, Hydration.NetApi.Generated.Model.primitive_types.H256 identity)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(reg_index.Encode());
            ...
            return new Method(17, "Identity", 9, "provide_judgement", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method KillIdentity(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
            return new Method(17, "Identity", 10, "kill_identity", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method AddSub(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 sub, Hydration.NetApi.Generated.Model.pallet_identity.types.EnumData data)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(sub.Encode());
            byteArray.AddRange(data.Encode());
            return new Method(17, "Identity", 11, "add_sub", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method RenameSub(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 sub, Hydration.NetApi.Generated.Model.pallet_identity.types.EnumData data)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(sub.Encode());
            byteArray.AddRange(data.Encode());
            return new Method(17, "Identity", 12, "rename_sub", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method RemoveSub(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 sub)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(sub.Encode());
            return new Method(17, "Identity", 13, "remove_sub", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(17, "Identity", 14, "quit_sub", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method AddUsernameAuthority(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 authority, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> suffix, Substrate.NetApi.Model.Types.Primitive.U32 allocation)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(authority.Encode());
            byteArray.AddRange(suffix.Encode());
            byteArray.AddRange(allocation.Encode());
            return new Method(17, "Identity", 15, "add_username_authority", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method AcceptUsername(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT1 username)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(username.Encode());
            return new Method(17, "Identity", 18, "accept_username", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method RemoveExpiredApproval(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT1 username)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(username.Encode());
            return new Method(17, "Identity", 19, "remove_expired_approval", byteArray.ToArray());
        }
        ...
        /// Identity pallet declaration.
        /// </summary>
        public static Method SetPrimaryUsername(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT1 username)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(username.Encode());
            return new Method(17, "Identity", 20, "set_primary_username", byteArray.ToArray());
        }
