...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class LiquidationStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Liquidation", "BorrowingContract"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.primitive_types.H160)));
        }
        ...
        ///  Borrowing market contract address
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.primitive_types.H160> BorrowingContract(string blockhash, CancellationToken token)
        {
    ...
    public sealed class LiquidationCalls
    {
        ...
        /// </summary>
        public static Method Liquidate(Substrate.NetApi.Model.Types.Primitive.U32 collateral_asset, Substrate.NetApi.Model.Types.Primitive.U32 debt_asset, Hydration.NetApi.Generated.Model.primitive_types.H160 user, Substrate.NetApi.Model.Types.Primitive.U128 debt_to_cover, Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11 route)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetBorrowingContract(Hydration.NetApi.Generated.Model.primitive_types.H160 contract)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
