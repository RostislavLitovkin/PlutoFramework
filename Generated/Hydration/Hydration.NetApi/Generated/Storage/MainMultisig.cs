...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class MultisigCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method PokeDeposit(Substrate.NetApi.Model.Types.Primitive.U16 threshold, Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32> other_signatories, Hydration.NetApi.Generated.Types.Base.Arr32U8 call_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(threshold.Encode());
            byteArray.AddRange(other_signatories.Encode());
            byteArray.AddRange(call_hash.Encode());
            return new Method(31, "Multisig", 4, "poke_deposit", byteArray.ToArray());
        }
    }
