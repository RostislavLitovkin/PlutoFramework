...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class DispatcherStorage
    {
        ...
        /// >> AaveManagerAccount
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32> AaveManagerAccount(string blockhash, CancellationToken token)
        {
    ...
    public sealed class DispatcherCalls
    {
        ...
        /// </summary>
        public static Method DispatchAsTreasury(Hydration.NetApi.Generated.Model.hydradx_runtime.EnumRuntimeCall call)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DispatchAsAaveManager(Hydration.NetApi.Generated.Model.hydradx_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method NoteAaveManager(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 account)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
