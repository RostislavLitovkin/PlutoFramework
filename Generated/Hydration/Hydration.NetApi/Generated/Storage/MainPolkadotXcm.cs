...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class PolkadotXcmStorage
    {
        ...
        public PolkadotXcmStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "VersionDiscoveryQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "LockedFungibles"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT57)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotXcm", "RecordedXcm"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.staging_xcm.v4.XcmT1)));
        }
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55> VersionDiscoveryQueue(string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.VersionDiscoveryQueueParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT57> LockedFungibles(Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.LockedFungiblesParams(key);
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT57>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.staging_xcm.v4.XcmT1> RecordedXcm(string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.RecordedXcmParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.staging_xcm.v4.XcmT1>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class PolkadotXcmCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceXcmVersion(Hydration.NetApi.Generated.Model.staging_xcm.v4.location.Location location, Substrate.NetApi.Model.Types.Primitive.U32 version)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
