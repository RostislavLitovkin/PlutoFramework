...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class BroadcastStorage
    {
        ...
        public BroadcastStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Broadcast", "ExecutionContext"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT76)));
        ...
        ///  Execution context to figure out where the trade is originated from
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT76> ExecutionContext(string blockhash, CancellationToken token)
        {
            string parameters = BroadcastStorage.ExecutionContextParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT76>(parameters, blockhash, token);
            return result;
        }
        ...
        /// If filled, we overwrite the original swapper. Mainly used in router to not to use temporary trade account
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.sp_core.crypto.AccountId32> Swapper(string blockhash, CancellationToken token)
        {
