...
namespace Hydration.NetApi.Generated.Storage
{
    ...
    public sealed class ParachainSystemStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UnincludedSegment"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ValidationData"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.polkadot_primitives.v8.PersistedValidationData)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpgradeRestrictionSignal"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.EnumUpgradeRestriction>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpgradeGoAhead"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.EnumUpgradeGoAhead>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "RelayStateProof"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.sp_trie.storage_proof.StorageProof)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "UpwardDeliveryFeeFactor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ReservedXcmpWeightOverride"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.sp_weights.weight_v2.Weight)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainSystem", "ReservedDmpWeightOverride"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Hydration.NetApi.Generated.Model.sp_weights.weight_v2.Weight)));
        ...
        ///  in the pallet.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>> UnincludedSegment(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UnincludedSegmentParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.Ancestor>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  respect to relay chain constraints.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.SegmentTracker> AggregatedUnincludedSegment(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.AggregatedUnincludedSegmentParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.unincluded_segment.SegmentTracker>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  in the trie.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.PersistedValidationData> ValidationData(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.ValidationDataParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.PersistedValidationData>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.EnumUpgradeRestriction>> UpgradeRestrictionSignal(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeRestrictionSignalParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.EnumUpgradeRestriction>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  set after the inherent.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.EnumUpgradeGoAhead>> UpgradeGoAhead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.UpgradeGoAheadParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.EnumUpgradeGoAhead>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.sp_trie.storage_proof.StorageProof> RelayStateProof(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelayStateProofParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.sp_trie.storage_proof.StorageProof>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot> RelevantMessagingState(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.RelevantMessagingStateParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.cumulus_pallet_parachain_system.relay_state_snapshot.MessagingStateSnapshot>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This data is also absent from the genesis.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.AbridgedHostConfiguration> HostConfiguration(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HostConfigurationParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.polkadot_primitives.v8.AbridgedHostConfiguration>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  by the system inherent.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain> LastDmqMqcHead(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.LastDmqMqcHeadParams();
            var result = await _client.GetStorageAsync<Hydration.NetApi.Generated.Model.cumulus_primitives_parachain_inherent.MessageQueueChain>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  This will be cleared in `on_initialize` of each new block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>> HrmpOutboundMessages(string blockhash, CancellationToken token)
        {
            string parameters = ParachainSystemStorage.HrmpOutboundMessagesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Hydration.NetApi.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The factor to multiply the base delivery fee by for UMP.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128> UpwardDeliveryFeeFactor(string blockhash, CancellationToken token)
        {
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.sp_weights.weight_v2.Weight> ReservedXcmpWeightOverride(string blockhash, CancellationToken token)
        {
        ...
        ///  overrides the amount set in the Config trait.
        /// </summary>
        public async Task<Hydration.NetApi.Generated.Model.sp_weights.weight_v2.Weight> ReservedDmpWeightOverride(string blockhash, CancellationToken token)
        {
    ...
    public sealed class ParachainSystemCalls
    {
        ...
        /// </summary>
        public static Method SetValidationData(Hydration.NetApi.Generated.Model.cumulus_primitives_parachain_inherent.ParachainInherentData data)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(data.Encode());
            return new Method(103, "ParachainSystem", 0, "set_validation_data", byteArray.ToArray());
        }
        ...
        public static Method SudoSendUpwardMessage(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> message)
        {
            ...
            return new Method(103, "ParachainSystem", 1, "sudo_send_upward_message", byteArray.ToArray());
        }
    }
    ...
    public sealed class ParachainSystemConstants
    {
        ...
        /// </summary>
        public Hydration.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id SelfParaId()
        {
            var result = new Hydration.NetApi.Generated.Model.polkadot_parachain_primitives.primitives.Id();
