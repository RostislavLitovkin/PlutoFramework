...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class AuraExtStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AuraExt", "Authorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT50)));
        ...
        ///  chain slot as provided by the relay chain state proof.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<XcavatePaseo.NetApi.Generated.Model.sp_consensus_slots.Slot, Substrate.NetApi.Model.Types.Primitive.U32>> RelaySlotInfo(string blockhash, CancellationToken token)
        {
