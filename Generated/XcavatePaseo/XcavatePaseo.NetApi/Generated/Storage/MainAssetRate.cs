...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class AssetRateStorage
    {
        ...
        public AssetRateStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRate", "ConversionRateToNative"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(XcavatePaseo.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
        }
        ...
        /// </summary>
        public static string ConversionRateToNativeParams(Substrate.NetApi.Model.Types.Primitive.U32 key)
        {
        ...
        ///  E.g. `native_amount = asset_amount * ConversionRateToNative::<T>::get(asset_kind)`
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128> ConversionRateToNative(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class AssetRateCalls
    {
        ...
        /// </summary>
        public static Method Create(Substrate.NetApi.Model.Types.Primitive.U32 asset_kind, XcavatePaseo.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128 rate)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Update(Substrate.NetApi.Model.Types.Primitive.U32 asset_kind, XcavatePaseo.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128 rate)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset_kind.Encode());
            byteArray.AddRange(rate.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Remove(Substrate.NetApi.Model.Types.Primitive.U32 asset_kind)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset_kind.Encode());
