...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class GameModuleStorage
    {
        ...
        public GameModuleStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GameModule", "Leaderboard"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GameModule", "GameProperties"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GameModule", "Admins"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GameModule", "RoundCollections"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(XcavatePaseo.NetApi.Generated.Model.pallet_game.types.CollectionRounds)));
        }
        ...
        ///  The leaderboard of the game.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT33> Leaderboard(string blockhash, CancellationToken token)
        {
        ...
        ///  A List of test properties
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34> GameProperties(string blockhash, CancellationToken token)
        {
        ...
        ///  Vector of admins who can register users.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35> Admins(string blockhash, CancellationToken token)
        {
        ...
        /// <summary>
        /// >> RoundCollectionsParams
        ///  Keeps track of the collection ids of a certain round.
        /// </summary>
        public static string RoundCollectionsParams(Substrate.NetApi.Model.Types.Primitive.U32 key)
        {
            return RequestGenerator.GetStorage("GameModule", "RoundCollections", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        
        /// <summary>
        /// >> RoundCollectionsDefault
        /// Default value as hex string
        /// </summary>
        public static string RoundCollectionsDefault()
        {
            return "0x00";
        }
        ...
        ///  Keeps track of the collection ids of a certain round.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.pallet_game.types.CollectionRounds> RoundCollections(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = GameModuleStorage.RoundCollectionsParams(key);
            var result = await _client.GetStorageAsync<XcavatePaseo.NetApi.Generated.Model.pallet_game.types.CollectionRounds>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class GameModuleCalls
    {
        ...
        public static Method SetupGame()
        {
            ...
            return new Method(84, "GameModule", 0, "setup_game", byteArray.ToArray());
        }
        ...
        public static Method RegisterUser(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 player)
        {
            ...
            return new Method(84, "GameModule", 1, "register_user", byteArray.ToArray());
        }
        ...
        public static Method GivePoints(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 receiver, Substrate.NetApi.Model.Types.Primitive.U32 amount)
        {
            ...
            return new Method(84, "GameModule", 2, "give_points", byteArray.ToArray());
        }
        ...
        public static Method PlayGame(XcavatePaseo.NetApi.Generated.Model.pallet_game.types.EnumDifficultyLevel game_type)
        {
            ...
            return new Method(84, "GameModule", 3, "play_game", byteArray.ToArray());
        }
        ...
        public static Method SubmitAnswer(Substrate.NetApi.Model.Types.Primitive.U32 guess, Substrate.NetApi.Model.Types.Primitive.U32 game_id)
        {
            ...
            return new Method(84, "GameModule", 4, "submit_answer", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CheckResult(Substrate.NetApi.Model.Types.Primitive.U64 guess, Substrate.NetApi.Model.Types.Primitive.U32 game_id, Substrate.NetApi.Model.Types.Primitive.U64 price, XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 secret)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(guess.Encode());
            byteArray.AddRange(game_id.Encode());
            ...
            return new Method(84, "GameModule", 5, "check_result", byteArray.ToArray());
        }
        ...
        public static Method ListNft(Substrate.NetApi.Model.Types.Primitive.U32 collection_id, Substrate.NetApi.Model.Types.Primitive.U32 item_id)
        {
            ...
            return new Method(84, "GameModule", 6, "list_nft", byteArray.ToArray());
        }
        ...
        public static Method DelistNft(Substrate.NetApi.Model.Types.Primitive.U32 listing_id)
        {
            ...
            return new Method(84, "GameModule", 7, "delist_nft", byteArray.ToArray());
        }
        ...
        public static Method MakeOffer(Substrate.NetApi.Model.Types.Primitive.U32 listing_id, Substrate.NetApi.Model.Types.Primitive.U32 collection_id, Substrate.NetApi.Model.Types.Primitive.U32 item_id)
        {
            ...
            byteArray.AddRange(collection_id.Encode());
            byteArray.AddRange(item_id.Encode());
            return new Method(84, "GameModule", 8, "make_offer", byteArray.ToArray());
        }
        ...
        public static Method WithdrawOffer(Substrate.NetApi.Model.Types.Primitive.U32 offer_id)
        {
            ...
            return new Method(84, "GameModule", 9, "withdraw_offer", byteArray.ToArray());
        }
        ...
        public static Method HandleOffer(Substrate.NetApi.Model.Types.Primitive.U32 offer_id, XcavatePaseo.NetApi.Generated.Model.pallet_game.types.EnumOffer offer)
        {
            ...
            return new Method(84, "GameModule", 10, "handle_offer", byteArray.ToArray());
        }
        ...
        public static Method AddProperty(XcavatePaseo.NetApi.Generated.Model.pallet_game.types.PropertyInfoData property)
        {
            ...
            return new Method(84, "GameModule", 11, "add_property", byteArray.ToArray());
        }
        ...
        public static Method RemoveProperty(Substrate.NetApi.Model.Types.Primitive.U32 id)
        {
            ...
            return new Method(84, "GameModule", 12, "remove_property", byteArray.ToArray());
        }
        ...
        public static Method AddToAdmins(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 new_admin)
        {
            ...
            return new Method(84, "GameModule", 13, "add_to_admins", byteArray.ToArray());
        }
        ...
        public static Method RemoveFromAdmins(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 admin)
        {
            ...
            return new Method(84, "GameModule", 14, "remove_from_admins", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(84, "GameModule", 15, "request_token", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method FinishGame(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 winner)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(winner.Encode());
            return new Method(84, "GameModule", 16, "finish_game", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DeleteAllGameProperties()
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(84, "GameModule", 17, "delete_all_game_properties", byteArray.ToArray());
        }
    }
    ...
    public sealed class GameModuleConstants
    {
        ...
        /// >> MaxRounds
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.U32 MaxRounds()
        {
            var result = new Substrate.NetApi.Model.Types.Primitive.U32();
