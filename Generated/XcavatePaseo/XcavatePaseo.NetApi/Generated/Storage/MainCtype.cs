...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class CtypeStorage
    {
        ...
        public CtypeStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ctype", "Ctypes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256), typeof(XcavatePaseo.NetApi.Generated.Model.ctype.ctype_entry.CtypeEntry)));
        }
        ...
        ///  was created.
        /// </summary>
        public static string CtypesParams(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  was created.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.ctype.ctype_entry.CtypeEntry> Ctypes(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = CtypeStorage.CtypesParams(key);
            var result = await _client.GetStorageAsync<XcavatePaseo.NetApi.Generated.Model.ctype.ctype_entry.CtypeEntry>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class CtypeCalls
    {
        ...
        public static Method Add(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> ctype)
        {
            ...
            return new Method(80, "Ctype", 0, "add", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetBlockNumber(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 ctype_hash, Substrate.NetApi.Model.Types.Primitive.U32 block_number)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(ctype_hash.Encode());
            byteArray.AddRange(block_number.Encode());
            return new Method(80, "Ctype", 1, "set_block_number", byteArray.ToArray());
        }
    }
