...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class DidStorage
    {
        ...
        public DidStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Did", "Did"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(XcavatePaseo.NetApi.Generated.Model.did.did_details.DidDetails)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Did", "ServiceEndpoints"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32, XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36>), typeof(XcavatePaseo.NetApi.Generated.Model.did.service_endpoints.DidEndpoint)));
        ...
        /// </summary>
        public static string DidParams(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  It maps from a DID identifier to the DID details.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.did.did_details.DidDetails> Did(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = DidStorage.DidParams(key);
            var result = await _client.GetStorageAsync<XcavatePaseo.NetApi.Generated.Model.did.did_details.DidDetails>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ServiceEndpointsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32, XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36> key)
        {
        ...
        ///  It maps from (DID identifier, service ID) to the service details.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.did.service_endpoints.DidEndpoint> ServiceEndpoints(Substrate.NetApi.Model.Types.Base.BaseTuple<XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32, XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36> key, string blockhash, CancellationToken token)
        {
            string parameters = DidStorage.ServiceEndpointsParams(key);
            var result = await _client.GetStorageAsync<XcavatePaseo.NetApi.Generated.Model.did.service_endpoints.DidEndpoint>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string DidEndpointsCountParams(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  It maps from (DID identifier) to a 32-bit counter.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> DidEndpointsCount(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  DID identifiers.
        /// </summary>
        public static string DidBlacklistParams(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  DID identifiers.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> DidBlacklist(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class DidCalls
    {
        ...
        /// </summary>
        public static Method Create(XcavatePaseo.NetApi.Generated.Model.did.did_details.DidCreationDetails details, XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidSignature signature)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(details.Encode());
            byteArray.AddRange(signature.Encode());
            return new Method(83, "Did", 0, "create", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAuthenticationKey(XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_key.Encode());
            return new Method(83, "Did", 1, "set_authentication_key", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetDelegationKey(XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_key.Encode());
            return new Method(83, "Did", 2, "set_delegation_key", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(83, "Did", 3, "remove_delegation_key", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAttestationKey(XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_key.Encode());
            return new Method(83, "Did", 4, "set_attestation_key", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(83, "Did", 5, "remove_attestation_key", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddKeyAgreementKey(XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidEncryptionKey new_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_key.Encode());
            return new Method(83, "Did", 6, "add_key_agreement_key", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveKeyAgreementKey(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 key_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(key_id.Encode());
            return new Method(83, "Did", 7, "remove_key_agreement_key", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddServiceEndpoint(XcavatePaseo.NetApi.Generated.Model.did.service_endpoints.DidEndpoint service_endpoint)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(service_endpoint.Encode());
            return new Method(83, "Did", 8, "add_service_endpoint", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveServiceEndpoint(XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT36 service_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(service_id.Encode());
            return new Method(83, "Did", 9, "remove_service_endpoint", byteArray.ToArray());
        }
        ...
        public static Method Delete(Substrate.NetApi.Model.Types.Primitive.U32 endpoints_to_remove)
        {
            ...
            return new Method(83, "Did", 10, "delete", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReclaimDeposit(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 did_subject, Substrate.NetApi.Model.Types.Primitive.U32 endpoints_to_remove)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(did_subject.Encode());
            byteArray.AddRange(endpoints_to_remove.Encode());
            return new Method(83, "Did", 11, "reclaim_deposit", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SubmitDidCall(XcavatePaseo.NetApi.Generated.Model.did.did_details.DidAuthorizedCallOperation did_call, XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidSignature signature)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(did_call.Encode());
            byteArray.AddRange(signature.Encode());
            return new Method(83, "Did", 12, "submit_did_call", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(83, "Did", 13, "change_deposit_owner", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateDeposit(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 did)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(did.Encode());
            return new Method(83, "Did", 14, "update_deposit", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DispatchAs(XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 did_identifier, XcavatePaseo.NetApi.Generated.Model.xcavate_runtime.EnumRuntimeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(did_identifier.Encode());
            byteArray.AddRange(call.Encode());
            return new Method(83, "Did", 15, "dispatch_as", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CreateFromAccount(XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidVerificationKey authentication_key)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(authentication_key.Encode());
            return new Method(83, "Did", 16, "create_from_account", byteArray.ToArray());
        }
    }
    ...
    public sealed class DidConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.U32 MaxBlocksTxValidity()
        {
            var result = new Substrate.NetApi.Model.Types.Primitive.U32();
