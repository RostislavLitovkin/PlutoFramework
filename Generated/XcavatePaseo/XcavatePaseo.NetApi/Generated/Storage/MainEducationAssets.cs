...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    /// <summary>
    /// >> EducationAssetsStorage
    /// </summary>
    public sealed class EducationAssetsStorage
    {
        ...
        /// <summary>
        /// >> EducationAssetsStorage Constructor
        /// </summary>
        public EducationAssetsStorage(SubstrateClientExt client)
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EducationAssets", "Asset"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EducationAssets", "Account"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EducationAssets", "Approvals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat,
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EducationAssets", "Metadata"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("EducationAssets", "NextAssetId"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        }
        ...
        {
            return RequestGenerator.GetStorage("EducationAssets", "Asset", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = EducationAssetsStorage.AssetParams(key);
        ...
        {
            return RequestGenerator.GetStorage("EducationAssets", "Account", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat,
        ...
        {
            string parameters = EducationAssetsStorage.AccountParams(key);
        ...
        {
            return RequestGenerator.GetStorage("EducationAssets", "Approvals", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat,
                        Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat,
                        Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, key.Value);
        }
        ...
        {
            string parameters = EducationAssetsStorage.ApprovalsParams(key);
        ...
        {
            return RequestGenerator.GetStorage("EducationAssets", "Metadata", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = EducationAssetsStorage.MetadataParams(key);
        ...
        {
            return RequestGenerator.GetStorage("EducationAssets", "NextAssetId", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = EducationAssetsStorage.NextAssetIdParams();
    ...
    /// <summary>
    /// >> EducationAssetsCalls
    /// </summary>
    public sealed class EducationAssetsCalls
    {
    ...
    /// <summary>
    /// >> EducationAssetsConstants
    /// </summary>
    public sealed class EducationAssetsConstants
    {
    ...
    /// <summary>
    /// >> EducationAssetsErrors
    /// </summary>
    public enum EducationAssetsErrors
    {
