...
namespace XcavatePaseo.NetApi.Generated.Storage
{
    ...
    public sealed class DelegationStorage
    {
        ...
        public DelegationStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Delegation", "DelegationNodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256), typeof(XcavatePaseo.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationNode)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Delegation", "DelegationHierarchies"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256), typeof(XcavatePaseo.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationHierarchyDetails)));
        }
        ...
        /// </summary>
        public static string DelegationNodesParams(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  It maps from a node ID to the node details.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationNode> DelegationNodes(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = DelegationStorage.DelegationNodesParams(key);
            var result = await _client.GetStorageAsync<XcavatePaseo.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationNode>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string DelegationHierarchiesParams(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  It maps for a (root) node ID to the hierarchy details.
        /// </summary>
        public async Task<XcavatePaseo.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationHierarchyDetails> DelegationHierarchies(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = DelegationStorage.DelegationHierarchiesParams(key);
            var result = await _client.GetStorageAsync<XcavatePaseo.NetApi.Generated.Model.delegation.delegation_hierarchy.DelegationHierarchyDetails>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class DelegationCalls
    {
        ...
        /// </summary>
        public static Method CreateHierarchy(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 root_node_id, XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 ctype_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(root_node_id.Encode());
            byteArray.AddRange(ctype_hash.Encode());
            return new Method(82, "Delegation", 0, "create_hierarchy", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddDelegation(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 delegation_id, XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 parent_id, XcavatePaseo.NetApi.Generated.Model.sp_core.crypto.AccountId32 @delegate, XcavatePaseo.NetApi.Generated.Model.delegation.delegation_hierarchy.Permissions permissions, XcavatePaseo.NetApi.Generated.Model.did.did_details.EnumDidSignature delegate_signature)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            return new Method(82, "Delegation", 1, "add_delegation", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RevokeDelegation(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 delegation_id, Substrate.NetApi.Model.Types.Primitive.U32 max_parent_checks, Substrate.NetApi.Model.Types.Primitive.U32 max_revocations)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
            byteArray.AddRange(max_parent_checks.Encode());
            byteArray.AddRange(max_revocations.Encode());
            return new Method(82, "Delegation", 2, "revoke_delegation", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveDelegation(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 delegation_id, Substrate.NetApi.Model.Types.Primitive.U32 max_removals)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
            byteArray.AddRange(max_removals.Encode());
            return new Method(82, "Delegation", 3, "remove_delegation", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReclaimDeposit(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 delegation_id, Substrate.NetApi.Model.Types.Primitive.U32 max_removals)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
            byteArray.AddRange(max_removals.Encode());
            return new Method(82, "Delegation", 4, "reclaim_deposit", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ChangeDepositOwner(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 delegation_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
            return new Method(82, "Delegation", 5, "change_deposit_owner", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateDeposit(XcavatePaseo.NetApi.Generated.Model.primitive_types.H256 delegation_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(delegation_id.Encode());
            return new Method(82, "Delegation", 6, "update_deposit", byteArray.ToArray());
        }
    }
