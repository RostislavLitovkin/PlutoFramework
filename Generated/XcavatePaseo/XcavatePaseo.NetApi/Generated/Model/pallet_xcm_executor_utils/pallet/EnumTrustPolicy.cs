...
namespace XcavatePaseo.NetApi.Generated.Model.pallet_xcm_executor_utils.pallet
{
    ...
    /// <summary>
    /// >> 362 - Variant[pallet_xcm_executor_utils.pallet.TrustPolicy]
    /// </summary>
    public sealed class EnumTrustPolicy : BaseEnumRust<TrustPolicy>
    {
        ...
        public EnumTrustPolicy()
        {
				...
				AddTypeDecoder<XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17>(TrustPolicy.AllowedAssets);
        }
    }
}
