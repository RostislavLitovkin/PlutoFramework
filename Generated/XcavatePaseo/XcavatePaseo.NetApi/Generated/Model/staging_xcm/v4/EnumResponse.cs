...
namespace XcavatePaseo.NetApi.Generated.Model.staging_xcm.v4
{
    ...
    /// <summary>
    /// >> 325 - Variant[staging_xcm.v4.Response]
    /// </summary>
    public sealed class EnumResponse : BaseEnumRust<Response>
    {
        ...
        public EnumResponse()
        {
				...
				AddTypeDecoder<XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14>(Response.PalletsInfo);
