...
namespace XcavatePaseo.NetApi.Generated.Model.staging_xcm.v4
{
    ...
    /// <summary>
    /// >> 360 - Variant[staging_xcm.v4.Response]
    /// </summary>
    public sealed class EnumResponse : BaseEnumRust<Response>
    {
        ...
        public EnumResponse()
        {
				...
				AddTypeDecoder<XcavatePaseo.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16>(Response.PalletsInfo);
