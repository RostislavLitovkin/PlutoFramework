...
namespace Polkadot.NetApi.Generated.Model.polkadot_primitives.v8
{
    ...
    /// <summary>
    /// >> 292 - Composite[polkadot_primitives.v8.CandidateCommitments]
    /// </summary>
    ...
    public sealed class CandidateCommitments : BaseType
    {
        ...
        /// >> upward_messages
        /// </summary>
        public Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3 UpwardMessages { get; set; }
        /// <summary>
        /// >> horizontal_messages
        /// </summary>
        public Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4 HorizontalMessages { get; set; }
        /// <summary>
        /// >> new_validation_code
        /// </summary>
        ...
        {
            var start = p;
            UpwardMessages = new Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3();
            UpwardMessages.Decode(byteArray, ref p);
            HorizontalMessages = new Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4();
