...
namespace Polkadot.NetApi.Generated.Model.staging_xcm.v5.asset
{
    ...
    /// <summary>
    /// >> 407 - Variant[staging_xcm.v5.asset.Fungibility]
    /// </summary>
    public sealed class EnumFungibility : BaseEnumRust<Fungibility>
    {
        ...
        public EnumFungibility()
        {
				...
				AddTypeDecoder<Polkadot.NetApi.Generated.Model.staging_xcm.v5.asset.EnumAssetInstance>(Fungibility.NonFungible);
        }
    }
}
