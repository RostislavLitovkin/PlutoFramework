...
namespace Polkadot.NetApi.Generated.Model.pallet_staking
{
    ...
    /// <summary>
    /// >> 583 - Composite[pallet_staking.Nominations]
    /// </summary>
    ...
    public sealed class Nominations : BaseType
    {
        ...
        /// >> targets
        /// </summary>
        public Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 Targets { get; set; }
        /// <summary>
        /// >> submitted_in
        /// </summary>
        ...
        {
            var start = p;
            Targets = new Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24();
