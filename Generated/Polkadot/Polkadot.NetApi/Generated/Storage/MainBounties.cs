...
namespace Polkadot.NetApi.Generated.Storage
{
    ...
    public sealed class BountiesStorage
    {
        ...
        ///  Bounties that have been made.
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.pallet_bounties.Bounty> Bounties(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = BountiesStorage.BountiesParams(key);
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.pallet_bounties.Bounty>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class BountiesCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ProposeCurator(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> bounty_id, Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress curator, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> fee)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(bounty_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AwardBounty(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> bounty_id, Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(bounty_id.Encode());
    ...
    public sealed class BountiesConstants
    {
        ...
        ///  `CuratorDepositMin`.
        /// </summary>
        public Polkadot.NetApi.Generated.Model.sp_arithmetic.per_things.Permill CuratorDepositMultiplier()
        {
