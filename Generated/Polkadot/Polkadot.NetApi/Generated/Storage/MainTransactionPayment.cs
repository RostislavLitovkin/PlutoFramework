...
namespace Polkadot.NetApi.Generated.Storage
{
    ...
    public sealed class TransactionPaymentStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TransactionPayment", "NextFeeMultiplier"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Polkadot.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TransactionPayment", "StorageVersion"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Polkadot.NetApi.Generated.Model.pallet_transaction_payment.EnumReleases)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TransactionPayment", "TxPaymentCredit"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Polkadot.NetApi.Generated.Model.frame_support.traits.storage.NoDrop)));
        }
        ...
        /// >> NextFeeMultiplier
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.sp_arithmetic.fixed_point.FixedU128> NextFeeMultiplier(string blockhash, CancellationToken token)
        {
        ...
        /// >> StorageVersion
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.pallet_transaction_payment.EnumReleases> StorageVersion(string blockhash, CancellationToken token)
        {
            string parameters = TransactionPaymentStorage.StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.pallet_transaction_payment.EnumReleases>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Use `withdraw_txfee` and `remaining_txfee` to access from outside the crate.
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.frame_support.traits.storage.NoDrop> TxPaymentCredit(string blockhash, CancellationToken token)
        {
            string parameters = TransactionPaymentStorage.TxPaymentCreditParams();
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.frame_support.traits.storage.NoDrop>(parameters, blockhash, token);
            return result;
        }
    }
