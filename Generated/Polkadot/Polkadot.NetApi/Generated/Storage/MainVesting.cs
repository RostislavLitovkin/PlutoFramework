...
namespace Polkadot.NetApi.Generated.Storage
{
    ...
    public sealed class VestingStorage
    {
        ...
        public VestingStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Vesting", "Vesting"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Polkadot.NetApi.Generated.Model.sp_core.crypto.AccountId32), typeof(Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Vesting", "StorageVersion"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Polkadot.NetApi.Generated.Model.pallet_vesting.EnumReleases)));
        }
        ...
        /// </summary>
        public static string VestingParams(Polkadot.NetApi.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Information regarding the vesting of a given account.
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29> Vesting(Polkadot.NetApi.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  New networks start with latest version, as determined by the genesis build.
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.pallet_vesting.EnumReleases> StorageVersion(string blockhash, CancellationToken token)
        {
            string parameters = VestingStorage.StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.pallet_vesting.EnumReleases>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class VestingCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VestOther(Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VestedTransfer(Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target, Polkadot.NetApi.Generated.Model.pallet_vesting.vesting_info.VestingInfo schedule)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceVestedTransfer(Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress source, Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target, Polkadot.NetApi.Generated.Model.pallet_vesting.vesting_info.VestingInfo schedule)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceRemoveVestingSchedule(Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress target, Substrate.NetApi.Model.Types.Primitive.U32 schedule_index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(target.Encode());
            byteArray.AddRange(schedule_index.Encode());
            return new Method(25, "Vesting", 5, "force_remove_vesting_schedule", byteArray.ToArray());
        }
    }
