...
namespace Polkadot.NetApi.Generated.Storage
{
    ...
    public sealed class BeefyStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Beefy", "Authorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Beefy", "NextAuthorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47)));
        ...
        ///  The current authorities set
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47> Authorities(string blockhash, CancellationToken token)
        {
            string parameters = BeefyStorage.AuthoritiesParams();
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Authorities set scheduled to be used with the next session
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47> NextAuthorities(string blockhash, CancellationToken token)
        {
