...
namespace Polkadot.NetApi.Generated.Storage
{
    ...
    public sealed class ParasSlashingStorage
    {
        ...
        ///  Validators pending dispute slashes.
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.polkadot_primitives.vstaging.PendingSlashes> UnappliedSlashes(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkadot.NetApi.Generated.Model.polkadot_core_primitives.CandidateHash> key, string blockhash, CancellationToken token)
        {
            string parameters = ParasSlashingStorage.UnappliedSlashesParams(key);
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.polkadot_primitives.vstaging.PendingSlashes>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class ParasSlashingCalls
    {
        ...
        /// </summary>
        public static Method ReportDisputeLostUnsigned(Polkadot.NetApi.Generated.Model.polkadot_primitives.vstaging.DisputeProof dispute_proof, Polkadot.NetApi.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
