...
namespace Polkadot.NetApi.Generated.Storage
{
    ...
    public sealed class TreasuryStorage
    {
        ...
        public async Task<Polkadot.NetApi.Generated.Model.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            ...
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.pallet_treasury.Proposal>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Spends that have been approved and being processed.
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.pallet_treasury.SpendStatus> Spends(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class TreasuryCalls
    {
        ...
        /// </summary>
        public static Method SpendLocal(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Polkadot.NetApi.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(amount.Encode());
            byteArray.AddRange(beneficiary.Encode());
            return new Method(19, "Treasury", 3, "spend_local", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Spend(Polkadot.NetApi.Generated.Model.polkadot_runtime_common.impls.EnumVersionedLocatableAsset asset_kind, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Polkadot.NetApi.Generated.Model.xcm.EnumVersionedLocation beneficiary, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> valid_from)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            return new Method(19, "Treasury", 5, "spend", byteArray.ToArray());
        }
        ...
        public static Method Payout(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(19, "Treasury", 6, "payout", byteArray.ToArray());
        }
        ...
        public static Method CheckStatus(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(19, "Treasury", 7, "check_status", byteArray.ToArray());
        }
        ...
        public static Method VoidSpend(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(19, "Treasury", 8, "void_spend", byteArray.ToArray());
        }
    }
    ...
    public sealed class TreasuryConstants
    {
        ...
        /// </summary>
        public Polkadot.NetApi.Generated.Model.sp_arithmetic.per_things.Permill Burn()
        {
