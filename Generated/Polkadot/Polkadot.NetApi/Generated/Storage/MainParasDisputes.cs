...
namespace Polkadot.NetApi.Generated.Storage
{
    ...
    public sealed class ParasDisputesStorage
    {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public async Task<Polkadot.NetApi.Generated.Model.polkadot_primitives.v8.DisputeState> Disputes(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkadot.NetApi.Generated.Model.polkadot_core_primitives.CandidateHash> key, string blockhash, CancellationToken token)
        {
            string parameters = ParasDisputesStorage.DisputesParams(key);
            var result = await _client.GetStorageAsync<Polkadot.NetApi.Generated.Model.polkadot_primitives.v8.DisputeState>(parameters, blockhash, token);
            return result;
        }
