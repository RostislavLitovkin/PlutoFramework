...
{
    public class PlutoFrameworkSubstrateClient : SubstrateClientExt
    {
        public PlutoFrameworkSubstrateClient(Endpoint endpoint, Uri fastestWebSocket, Substrate.NetApi.Model.Extrinsics.ChargeType chargeType) :
